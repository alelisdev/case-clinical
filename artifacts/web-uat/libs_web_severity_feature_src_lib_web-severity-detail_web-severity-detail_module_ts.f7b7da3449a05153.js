"use strict";
(self["webpackChunkweb"] = self["webpackChunkweb"] || []).push([["libs_web_severity_feature_src_lib_web-severity-detail_web-severity-detail_module_ts"],{

/***/ 357846:
/*!**********************************************************************************************!*\
  !*** ./libs/web/severity/feature/src/lib/web-severity-detail/overview/overview.component.ts ***!
  \**********************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "WebSeverityOverviewComponent": () => (/* binding */ WebSeverityOverviewComponent)
/* harmony export */ });
/* harmony import */ var _case_clinical_web_severity_shared__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @case-clinical/web/severity/shared */ 621270);
...
function WebSeverityOverviewComponent_ng_container_0_ng_container_1_Template(rf, ctx) {
  if (rf & 1) {
...
function WebSeverityOverviewComponent_ng_container_0_Template(rf, ctx) {
  if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementContainerStart"](0);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](1, WebSeverityOverviewComponent_ng_container_0_ng_container_1_Template, 2, 3, "ng-container", 0);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementContainerEnd"]();
  }
  if (rf & 2) {
...
class WebSeverityOverviewComponent {
  ...
  ngOnInit() {
    this.store.loadSeverityEffect(this.route.params.pipe((0,rxjs__WEBPACK_IMPORTED_MODULE_1__.pluck)('severityId')));
  ...
  deleteItem(item) {
    if (confirm('Are you sure?')) {
      this.store.deleteSeverityEffect();
    }
  }
  leadInjuryAdded($event) {
    console.log('from the overview in Severity, added: ', $event);
  }
}
WebSeverityOverviewComponent.ɵfac = function WebSeverityOverviewComponent_Factory(t) {
  return new (t || WebSeverityOverviewComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_case_clinical_web_severity_shared__WEBPACK_IMPORTED_MODULE_2__.WebSeverityFeatureStore), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_3__.Router), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_3__.ActivatedRoute));
};
WebSeverityOverviewComponent.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
  type: WebSeverityOverviewComponent,
  selectors: [["ng-component"]],
  features: [_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵProvidersFeature"]([_case_clinical_web_severity_shared__WEBPACK_IMPORTED_MODULE_2__.WebSeverityFeatureStore])],
  decls: 2,
  vars: 3,
  consts: [[4, "ngIf"], ["formName", "severity_overview", 3, "showSubmitButton", "componentStore", "model"]],
  template: function WebSeverityOverviewComponent_Template(rf, ctx) {
    if (rf & 1) {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](0, WebSeverityOverviewComponent_ng_container_0_Template, 2, 1, "ng-container", 0);
...
/***/ 943645:
/*!************************************************************************************************!*\
  !*** ./libs/web/severity/feature/src/lib/web-severity-detail/web-severity-detail.component.ts ***!
  \************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "WebSeverityDetailComponent": () => (/* binding */ WebSeverityDetailComponent)
/* harmony export */ });
/* harmony import */ var _web_severity_detail_store__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./web-severity-detail.store */ 708260);
...
const _c0 = ["matDrawer"];
class WebSeverityDetailComponent {
  ...
  deleteItem(item) {
    if (confirm('Are you sure?')) {
      this.store.deleteSeverityEffect(item);
    }
  }
}
WebSeverityDetailComponent.ɵfac = function WebSeverityDetailComponent_Factory(t) {
  return new (t || WebSeverityDetailComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdirectiveInject"](_web_severity_detail_store__WEBPACK_IMPORTED_MODULE_4__.WebSeverityDetailStore), _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_5__.ActivatedRoute), _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdirectiveInject"](_angular_core__WEBPACK_IMPORTED_MODULE_3__.ChangeDetectorRef), _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdirectiveInject"](_fuse_services_media_watcher__WEBPACK_IMPORTED_MODULE_6__.FuseMediaWatcherService));
};
WebSeverityDetailComponent.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdefineComponent"]({
  type: WebSeverityDetailComponent,
  selectors: [["ng-component"]],
  viewQuery: function WebSeverityDetailComponent_Query(rf, ctx) {
    if (rf & 1) {
  ...
  features: [_angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵProvidersFeature"]([_web_severity_detail_store__WEBPACK_IMPORTED_MODULE_4__.WebSeverityDetailStore])],
  decls: 8,
  vars: 8,
  ...
  template: function WebSeverityDetailComponent_Template(rf, ctx) {
    if (rf & 1) {
...
/***/ 217293:
/*!*********************************************************************************************!*\
  !*** ./libs/web/severity/feature/src/lib/web-severity-detail/web-severity-detail.module.ts ***!
  \*********************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "WebSeverityDetailModule": () => (/* binding */ WebSeverityDetailModule)
/* harmony export */ });
...
/* harmony import */ var _web_severity_detail_component__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ./web-severity-detail.component */ 943645);
/* harmony import */ var _overview_overview_component__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ./overview/overview.component */ 357846);
...
class WebSeverityDetailModule {}
WebSeverityDetailModule.ɵfac = function WebSeverityDetailModule_Factory(t) {
  return new (t || WebSeverityDetailModule)();
};
WebSeverityDetailModule.ɵmod = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineNgModule"]({
  type: WebSeverityDetailModule
});
WebSeverityDetailModule.ɵinj = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
  imports: [_angular_material_button__WEBPACK_IMPORTED_MODULE_1__.MatButtonModule, _angular_material_icon__WEBPACK_IMPORTED_MODULE_2__.MatIconModule, _angular_material_sidenav__WEBPACK_IMPORTED_MODULE_3__.MatSidenavModule, _angular_material_tree__WEBPACK_IMPORTED_MODULE_4__.MatTreeModule, _fuse_components_highlight__WEBPACK_IMPORTED_MODULE_5__.FuseHighlightModule, _fuse_components_alert__WEBPACK_IMPORTED_MODULE_6__.FuseAlertModule, _fuse_components_navigation__WEBPACK_IMPORTED_MODULE_7__.FuseNavigationModule, _fuse_directives_scroll_reset__WEBPACK_IMPORTED_MODULE_8__.FuseScrollResetModule, libs_shared_shared_module__WEBPACK_IMPORTED_MODULE_9__.SharedModule, _angular_common__WEBPACK_IMPORTED_MODULE_10__.CommonModule, _case_clinical_web_ui_panel__WEBPACK_IMPORTED_MODULE_11__.WebUiPanelModule, _case_clinical_web_ui_description_list__WEBPACK_IMPORTED_MODULE_12__.WebUiDescriptionListModule, _case_clinical_web_ui_card_header__WEBPACK_IMPORTED_MODULE_13__.WebUiCardHeaderModule, _case_clinical_web_ui_page__WEBPACK_IMPORTED_MODULE_14__.WebUiPageModule, _case_clinical_web_shared_ui__WEBPACK_IMPORTED_MODULE_15__.UtilitySharedModule, _case_clinical_web_shared_ui__WEBPACK_IMPORTED_MODULE_16__.UiFormsSharedModule, _case_clinical_web_core_feature__WEBPACK_IMPORTED_MODULE_17__.WebCoreFeatureModule, _case_clinical_web_ui_formly_designer__WEBPACK_IMPORTED_MODULE_18__.WebUiFormlyDesignerModule, _angular_router__WEBPACK_IMPORTED_MODULE_19__.RouterModule.forChild([{
    path: '',
    component: _web_severity_detail_component__WEBPACK_IMPORTED_MODULE_20__.WebSeverityDetailComponent,
    children: [{
      path: 'overview',
      pathMatch: 'full',
      component: _overview_overview_component__WEBPACK_IMPORTED_MODULE_21__.WebSeverityOverviewComponent
    }, {
      path: 'edit',
      loadChildren: () => __webpack_require__.e(/*! import() */ "libs_web_severity_feature_src_lib_web-severity-edit_web-severity-edit_module_ts").then(__webpack_require__.bind(__webpack_require__, /*! ../web-severity-edit/web-severity-edit.module */ 199111)).then(m => m.WebSeverityEditModule)
    }, {
      path: 'lead-injuries',
...
(function () {
  (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](WebSeverityDetailModule, {
    declarations: [_web_severity_detail_component__WEBPACK_IMPORTED_MODULE_20__.WebSeverityDetailComponent, _overview_overview_component__WEBPACK_IMPORTED_MODULE_21__.WebSeverityOverviewComponent],
...
/***/ 708260:
/*!********************************************************************************************!*\
  !*** ./libs/web/severity/feature/src/lib/web-severity-detail/web-severity-detail.store.ts ***!
  \********************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "WebSeverityDetailStore": () => (/* binding */ WebSeverityDetailStore)
/* harmony export */ });
...
class WebSeverityDetailStore extends _ngrx_component_store__WEBPACK_IMPORTED_MODULE_0__.ComponentStore {
  constructor(data, router, route, toast) {
    ...
    this.loadSeverityEffect = this.effect(severityId$ => severityId$.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_1__.tap)(() => this.setState({
      loading: true
    ...
    this.deleteSeverityEffect = this.effect(severity$ => severity$.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.switchMap)(severity => this.data.userDeleteSeverity({
      severityId: severity.id
    }).pipe((0,_ngrx_component_store__WEBPACK_IMPORTED_MODULE_0__.tapResponse)(res => {
      this.toast.success("Deleted successfully!", {
        duration: 3000
      });
      return this.router.navigate(['/queues/severities']);
    }, errors => this.patchState({
      loading: false,
      errors: errors.graphQLErrors ? errors.graphQLErrors : errors
    }))))));
    this.loadSeverityEffect(route.params.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.pluck)('severityId')));
  }
}
WebSeverityDetailStore.ɵfac = function WebSeverityDetailStore_Factory(t) {
  return new (t || WebSeverityDetailStore)(_angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵinject"](_case_clinical_web_core_data_access__WEBPACK_IMPORTED_MODULE_5__.WebCoreDataAccessService), _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵinject"](_angular_router__WEBPACK_IMPORTED_MODULE_6__.Router), _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵinject"](_angular_router__WEBPACK_IMPORTED_MODULE_6__.ActivatedRoute), _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵinject"](_case_clinical_web_ui_toast__WEBPACK_IMPORTED_MODULE_7__.WebUiToastService));
};
WebSeverityDetailStore.ɵprov = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵdefineInjectable"]({
  token: WebSeverityDetailStore,
  factory: WebSeverityDetailStore.ɵfac
});
