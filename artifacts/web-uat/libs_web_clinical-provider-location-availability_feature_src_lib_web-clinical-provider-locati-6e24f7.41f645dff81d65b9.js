"use strict";
(self["webpackChunkweb"] = self["webpackChunkweb"] || []).push([["libs_web_clinical-provider-location-availability_feature_src_lib_web-clinical-provider-locati-6e24f7"],{

/***/ 205541:
/*!*****************************************************************************************************************************************************************************************!*\
  !*** ./libs/web/clinical-provider-location-availability/feature/src/lib/web-clinical-provider-location-availability-list/web-clinical-provider-location-availability-list.component.ts ***!
  \*****************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "WebClinicalProviderLocationAvailabilityListComponent": () => (/* binding */ WebClinicalProviderLocationAvailabilityListComponent)
/* harmony export */ });
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! rxjs */ 469751);
/* harmony import */ var _case_clinical_web_core_data_access__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @case-clinical/web/core/data-access */ 251645);
/* harmony import */ var _case_clinical_web_clinical_provider_location_availability_shared__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @case-clinical/web/clinical-provider-location-availability/shared */ 192716);
/* harmony import */ var _case_clinical_web_clinical_provider_location_availability_ui__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @case-clinical/web/clinical-provider-location-availability/ui */ 83052);
/* harmony import */ var _case_clinical_web_clinical_provider_location_shared__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @case-clinical/web/clinical-provider-location/shared */ 988473);
...
function WebClinicalProviderLocationAvailabilityListComponent_ng_container_0_ng_container_1_Template(rf, ctx) {
  if (rf & 1) {
    const _r4 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementContainerStart"](0);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](1, "ui-data-list", 2);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("searchQueryDidChange", function WebClinicalProviderLocationAvailabilityListComponent_ng_container_0_ng_container_1_Template_ui_data_list_searchQueryDidChange_1_listener($event) {
    ...
    })("excelDataHasBeenPopulated", function WebClinicalProviderLocationAvailabilityListComponent_ng_container_0_ng_container_1_Template_ui_data_list_excelDataHasBeenPopulated_1_listener($event) {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r4);
  ...
  if (rf & 2) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("data", vm_r2.clinicalProviderLocationAvailabilities)("columnDefs", ctx_r1.columnDefs)("validateFunc", ctx_r1.validateImportData)("createNewFunc", ctx_r1.createNewFunc);
  }
}
function WebClinicalProviderLocationAvailabilityListComponent_ng_container_0_Template(rf, ctx) {
  if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementContainerStart"](0);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](1, WebClinicalProviderLocationAvailabilityListComponent_ng_container_0_ng_container_1_Template, 2, 4, "ng-container", 1);
...
class WebClinicalProviderLocationAvailabilityListComponent {
  constructor(store, clinicalProviderLocationFeatureStore) {
    this.store = store;
...
WebClinicalProviderLocationAvailabilityListComponent.ɵfac = function WebClinicalProviderLocationAvailabilityListComponent_Factory(t) {
  return new (t || WebClinicalProviderLocationAvailabilityListComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_case_clinical_web_clinical_provider_location_availability_shared__WEBPACK_IMPORTED_MODULE_3__.WebClinicalProviderLocationAvailabilityFeatureStore), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_case_clinical_web_clinical_provider_location_shared__WEBPACK_IMPORTED_MODULE_4__.WebClinicalProviderLocationFeatureStore));
};
WebClinicalProviderLocationAvailabilityListComponent.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
  type: WebClinicalProviderLocationAvailabilityListComponent,
  selectors: [["ng-component"]],
  viewQuery: function WebClinicalProviderLocationAvailabilityListComponent_Query(rf, ctx) {
    if (rf & 1) {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵviewQuery"](_case_clinical_web_clinical_provider_location_availability_ui__WEBPACK_IMPORTED_MODULE_5__.WebClinicalProviderLocationAvailabilitySelectTableViewComponent, 5);
    }
    if (rf & 2) {
      let _t;
  ...
  features: [_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵProvidersFeature"]([_case_clinical_web_clinical_provider_location_availability_shared__WEBPACK_IMPORTED_MODULE_3__.WebClinicalProviderLocationAvailabilityFeatureStore, _case_clinical_web_clinical_provider_location_shared__WEBPACK_IMPORTED_MODULE_4__.WebClinicalProviderLocationFeatureStore])],
  decls: 1,
  vars: 1,
  consts: [[4, "featureFlag"], [4, "ngIf"], ["tableName", "clinicalProviderLocationAvailability", "title", "ClinicalProviderLocationAvailability", 1, "h-full", "w-full", 3, "data", "columnDefs", "validateFunc", "createNewFunc", "searchQueryDidChange", "excelDataHasBeenPopulated"]],
  template: function WebClinicalProviderLocationAvailabilityListComponent_Template(rf, ctx) {
    if (rf & 1) {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](0, WebClinicalProviderLocationAvailabilityListComponent_ng_container_0_Template, 3, 3, "ng-container", 0);
    }
    if (rf & 2) {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("featureFlag", "ClinicalProviderLocationAvailability.View");
    }
  },
...
/***/ 115148:
/*!**************************************************************************************************************************************************************************************!*\
  !*** ./libs/web/clinical-provider-location-availability/feature/src/lib/web-clinical-provider-location-availability-list/web-clinical-provider-location-availability-list.module.ts ***!
  \**************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "WebClinicalProviderLocationAvailabilityListModule": () => (/* binding */ WebClinicalProviderLocationAvailabilityListModule)
/* harmony export */ });
...
/* harmony import */ var _web_clinical_provider_location_availability_list_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./web-clinical-provider-location-availability-list.component */ 205541);
...
class WebClinicalProviderLocationAvailabilityListModule {}
WebClinicalProviderLocationAvailabilityListModule.ɵfac = function WebClinicalProviderLocationAvailabilityListModule_Factory(t) {
  return new (t || WebClinicalProviderLocationAvailabilityListModule)();
};
WebClinicalProviderLocationAvailabilityListModule.ɵmod = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineNgModule"]({
  type: WebClinicalProviderLocationAvailabilityListModule
});
WebClinicalProviderLocationAvailabilityListModule.ɵinj = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
  imports: [_angular_common__WEBPACK_IMPORTED_MODULE_1__.CommonModule, _angular_router__WEBPACK_IMPORTED_MODULE_2__.RouterModule.forChild([{
    path: '',
    component: _web_clinical_provider_location_availability_list_component__WEBPACK_IMPORTED_MODULE_3__.WebClinicalProviderLocationAvailabilityListComponent
...
(function () {
  (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](WebClinicalProviderLocationAvailabilityListModule, {
    declarations: [_web_clinical_provider_location_availability_list_component__WEBPACK_IMPORTED_MODULE_3__.WebClinicalProviderLocationAvailabilityListComponent],
