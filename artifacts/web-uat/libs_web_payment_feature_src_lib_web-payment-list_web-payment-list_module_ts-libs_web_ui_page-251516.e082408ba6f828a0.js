"use strict";
(self["webpackChunkweb"] = self["webpackChunkweb"] || []).push([["libs_web_payment_feature_src_lib_web-payment-list_web-payment-list_module_ts-libs_web_ui_page-251516"],{

/***/ 637520:
/*!*****************************************************************************************!*\
  !*** ./libs/web/payment/feature/src/lib/web-payment-list/web-payment-list.component.ts ***!
  \*****************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "WebPaymentListComponent": () => (/* binding */ WebPaymentListComponent)
/* harmony export */ });
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! rxjs */ 469751);
/* harmony import */ var _case_clinical_web_core_data_access__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @case-clinical/web/core/data-access */ 251645);
/* harmony import */ var _case_clinical_web_payment_shared__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @case-clinical/web/payment/shared */ 113727);
/* harmony import */ var _case_clinical_web_payment_ui__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! @case-clinical/web/payment/ui */ 894355);
/* harmony import */ var _case_clinical_web_batch_control_shared__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @case-clinical/web/batch-control/shared */ 294238);
/* harmony import */ var _case_clinical_web_bank_shared__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @case-clinical/web/bank/shared */ 493702);
/* harmony import */ var _case_clinical_web_payor_type_shared__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @case-clinical/web/payor-type/shared */ 548620);
/* harmony import */ var _case_clinical_web_payment_type_shared__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @case-clinical/web/payment-type/shared */ 334716);
/* harmony import */ var _case_clinical_web_payment_application_method_shared__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! @case-clinical/web/payment-application-method/shared */ 423809);
...
function WebPaymentListComponent_ng_container_0_ng_container_1_Template(rf, ctx) {
  if (rf & 1) {
    const _r4 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementContainerStart"](0);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](1, "ui-data-list", 2);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("searchQueryDidChange", function WebPaymentListComponent_ng_container_0_ng_container_1_Template_ui_data_list_searchQueryDidChange_1_listener($event) {
    ...
    })("excelDataHasBeenPopulated", function WebPaymentListComponent_ng_container_0_ng_container_1_Template_ui_data_list_excelDataHasBeenPopulated_1_listener($event) {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r4);
  ...
  if (rf & 2) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("data", vm_r2.payments)("columnDefs", ctx_r1.columnDefs)("validateFunc", ctx_r1.validateImportData)("createNewFunc", ctx_r1.createNewFunc);
  }
}
function WebPaymentListComponent_ng_container_0_Template(rf, ctx) {
  if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementContainerStart"](0);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](1, WebPaymentListComponent_ng_container_0_ng_container_1_Template, 2, 4, "ng-container", 1);
...
class WebPaymentListComponent {
  constructor(store, batchControlFeatureStore, bankFeatureStore, payorTypeFeatureStore, paymentTypeFeatureStore, paymentApplicationMethodFeatureStore) {
    this.store = store;
    this.batchControlFeatureStore = batchControlFeatureStore;
    this.bankFeatureStore = bankFeatureStore;
    this.payorTypeFeatureStore = payorTypeFeatureStore;
    this.paymentTypeFeatureStore = paymentTypeFeatureStore;
    this.paymentApplicationMethodFeatureStore = paymentApplicationMethodFeatureStore;
    this.vm$ = this.store.vm$;
    this.columnDefs = [{
      field: 'batchControl.name',
      headerName: 'Batch Control',
      ...
      field: 'paymentApplicationMethod.name',
      headerName: 'Payment Application Method',
      filter: 'agTextColumnFilter'
    }, {
      field: 'id',
      filter: 'agTextColumnFilter',
      ...
      valueFormatter: params => {
        var _a;
        return (0,_case_clinical_web_core_data_access__WEBPACK_IMPORTED_MODULE_1__.currencyFormatter)((_a = params.data) === null || _a === void 0 ? void 0 : _a.collected, '$', 2);
      },
      filter: 'agNumberColumnFilter',
      aggFunc: 'sum'
    }, {
      ...
      valueFormatter: params => {
        var _a;
        return (0,_case_clinical_web_core_data_access__WEBPACK_IMPORTED_MODULE_1__.currencyFormatter)((_a = params.data) === null || _a === void 0 ? void 0 : _a.dac, '$', 2);
      },
      filter: 'agNumberColumnFilter',
      aggFunc: 'sum'
    }, {
      ...
      field: 'securitizationGroup',
      filter: 'agTextColumnFilter'
    }, {
      field: 'paymentApplicationMethodId',
      filter: 'agTextColumnFilter',
      hide: true
    }];
        ...
        case 'batchControl':
          {
            ...
            this.batchControlFeatureStore.createBatchControlEffect({
              name: newName
            });
            break;
          }
        case 'bank':
          {
            ...
            this.bankFeatureStore.createBankEffect({
              name: newName
            });
            break;
          }
        case 'payorType':
          {
            ...
            this.payorTypeFeatureStore.createPayorTypeEffect({
              name: newName
            });
            break;
          }
        case 'paymentType':
          {
            ...
            this.paymentTypeFeatureStore.createPaymentTypeEffect({
              name: newName
            });
            break;
          }
        case 'paymentApplicationMethod':
          {
            ...
            this.paymentApplicationMethodFeatureStore.createPaymentApplicationMethodEffect({
              name: newName
            });
            break;
          }
...
WebPaymentListComponent.ɵfac = function WebPaymentListComponent_Factory(t) {
  return new (t || WebPaymentListComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_case_clinical_web_payment_shared__WEBPACK_IMPORTED_MODULE_3__.WebPaymentFeatureStore), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_case_clinical_web_batch_control_shared__WEBPACK_IMPORTED_MODULE_4__.WebBatchControlFeatureStore), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_case_clinical_web_bank_shared__WEBPACK_IMPORTED_MODULE_5__.WebBankFeatureStore), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_case_clinical_web_payor_type_shared__WEBPACK_IMPORTED_MODULE_6__.WebPayorTypeFeatureStore), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_case_clinical_web_payment_type_shared__WEBPACK_IMPORTED_MODULE_7__.WebPaymentTypeFeatureStore), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_case_clinical_web_payment_application_method_shared__WEBPACK_IMPORTED_MODULE_8__.WebPaymentApplicationMethodFeatureStore));
};
WebPaymentListComponent.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
  type: WebPaymentListComponent,
  selectors: [["ng-component"]],
  viewQuery: function WebPaymentListComponent_Query(rf, ctx) {
    if (rf & 1) {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵviewQuery"](_case_clinical_web_payment_ui__WEBPACK_IMPORTED_MODULE_9__.WebPaymentSelectTableViewComponent, 5);
    }
    if (rf & 2) {
      let _t;
  ...
  features: [_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵProvidersFeature"]([_case_clinical_web_payment_shared__WEBPACK_IMPORTED_MODULE_3__.WebPaymentFeatureStore, _case_clinical_web_batch_control_shared__WEBPACK_IMPORTED_MODULE_4__.WebBatchControlFeatureStore, _case_clinical_web_bank_shared__WEBPACK_IMPORTED_MODULE_5__.WebBankFeatureStore, _case_clinical_web_payor_type_shared__WEBPACK_IMPORTED_MODULE_6__.WebPayorTypeFeatureStore, _case_clinical_web_payment_type_shared__WEBPACK_IMPORTED_MODULE_7__.WebPaymentTypeFeatureStore, _case_clinical_web_payment_application_method_shared__WEBPACK_IMPORTED_MODULE_8__.WebPaymentApplicationMethodFeatureStore])],
  decls: 1,
  vars: 1,
  consts: [[4, "featureFlag"], [4, "ngIf"], ["tableName", "payment", "title", "Payment", 1, "h-full", "w-full", 3, "data", "columnDefs", "validateFunc", "createNewFunc", "searchQueryDidChange", "excelDataHasBeenPopulated"]],
  template: function WebPaymentListComponent_Template(rf, ctx) {
    if (rf & 1) {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](0, WebPaymentListComponent_ng_container_0_Template, 3, 3, "ng-container", 0);
    }
    if (rf & 2) {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("featureFlag", "Payment.View");
    }
  },
...
/***/ 756085:
/*!**************************************************************************************!*\
  !*** ./libs/web/payment/feature/src/lib/web-payment-list/web-payment-list.module.ts ***!
  \**************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "WebPaymentListModule": () => (/* binding */ WebPaymentListModule)
/* harmony export */ });
...
/* harmony import */ var _web_payment_list_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./web-payment-list.component */ 637520);
...
class WebPaymentListModule {}
WebPaymentListModule.ɵfac = function WebPaymentListModule_Factory(t) {
  return new (t || WebPaymentListModule)();
};
WebPaymentListModule.ɵmod = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineNgModule"]({
  type: WebPaymentListModule
});
WebPaymentListModule.ɵinj = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
  imports: [_angular_common__WEBPACK_IMPORTED_MODULE_1__.CommonModule, _angular_router__WEBPACK_IMPORTED_MODULE_2__.RouterModule.forChild([{
    path: '',
    component: _web_payment_list_component__WEBPACK_IMPORTED_MODULE_3__.WebPaymentListComponent
...
(function () {
  (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](WebPaymentListModule, {
    declarations: [_web_payment_list_component__WEBPACK_IMPORTED_MODULE_3__.WebPaymentListComponent],
...
/***/ 894355:
/*!************************************************************************************************!*\
  !*** ./libs/web/payment/ui/web-payment-select-form/web-payment-select-table-view.component.ts ***!
  \************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "WebPaymentSelectTableViewComponent": () => (/* binding */ WebPaymentSelectTableViewComponent)
/* harmony export */ });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ 94650);
/* harmony import */ var _case_clinical_web_core_data_access__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @case-clinical/web/core/data-access */ 251645);
...
class WebPaymentSelectTableViewComponent {
  constructor() {
...
WebPaymentSelectTableViewComponent.ɵfac = function WebPaymentSelectTableViewComponent_Factory(t) {
  return new (t || WebPaymentSelectTableViewComponent)();
};
WebPaymentSelectTableViewComponent.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
  type: WebPaymentSelectTableViewComponent,
  selectors: [["ui-payment-select-table-view"]],
  viewQuery: function WebPaymentSelectTableViewComponent_Query(rf, ctx) {
    if (rf & 1) {
  ...
  template: function WebPaymentSelectTableViewComponent_Template(rf, ctx) {
    if (rf & 1) {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "table-view", 0);
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("itemDidSelect", function WebPaymentSelectTableViewComponent_Template_table_view_itemDidSelect_0_listener($event) {
        return ctx.onSelected($event);
      })("selectionDidChange", function WebPaymentSelectTableViewComponent_Template_table_view_selectionDidChange_0_listener($event) {
        return ctx.selectionDidChange($event);
      });
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
    }
    if (rf & 2) {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("autoHeight", ctx.autoHeight)("showSidebar", false)("data", ctx.payments)("suppressRowClickSelection", false)("columnDefs", ctx.columnDefs);
    }
  },
