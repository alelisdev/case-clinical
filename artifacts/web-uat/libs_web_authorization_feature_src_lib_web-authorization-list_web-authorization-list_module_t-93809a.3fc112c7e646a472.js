"use strict";
(self["webpackChunkweb"] = self["webpackChunkweb"] || []).push([["libs_web_authorization_feature_src_lib_web-authorization-list_web-authorization-list_module_t-93809a"],{

/***/ 795277:
/*!***********************************************************************************************************!*\
  !*** ./libs/web/authorization/feature/src/lib/web-authorization-list/web-authorization-list.component.ts ***!
  \***********************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "WebAuthorizationListComponent": () => (/* binding */ WebAuthorizationListComponent)
/* harmony export */ });
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! rxjs */ 469751);
/* harmony import */ var _case_clinical_web_core_data_access__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @case-clinical/web/core/data-access */ 251645);
/* harmony import */ var _case_clinical_web_authorization_shared__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @case-clinical/web/authorization/shared */ 778774);
/* harmony import */ var _case_clinical_web_authorization_ui__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! @case-clinical/web/authorization/ui */ 948308);
...
/* harmony import */ var _case_clinical_web_authorization_category_shared__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @case-clinical/web/authorization-category/shared */ 106276);
/* harmony import */ var _case_clinical_web_authorization_type_shared__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @case-clinical/web/authorization-type/shared */ 900269);
/* harmony import */ var _case_clinical_web_procedure_shared__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @case-clinical/web/procedure/shared */ 632277);
...
function WebAuthorizationListComponent_ng_container_0_ng_container_1_Template(rf, ctx) {
  if (rf & 1) {
    const _r4 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementContainerStart"](0);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](1, "ui-data-list", 2);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("searchQueryDidChange", function WebAuthorizationListComponent_ng_container_0_ng_container_1_Template_ui_data_list_searchQueryDidChange_1_listener($event) {
    ...
    })("excelDataHasBeenPopulated", function WebAuthorizationListComponent_ng_container_0_ng_container_1_Template_ui_data_list_excelDataHasBeenPopulated_1_listener($event) {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r4);
  ...
  if (rf & 2) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("data", vm_r2.authorizations)("columnDefs", ctx_r1.columnDefs)("validateFunc", ctx_r1.validateImportData)("createNewFunc", ctx_r1.createNewFunc);
  }
}
function WebAuthorizationListComponent_ng_container_0_Template(rf, ctx) {
  if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementContainerStart"](0);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](1, WebAuthorizationListComponent_ng_container_0_ng_container_1_Template, 2, 4, "ng-container", 1);
...
class WebAuthorizationListComponent {
  constructor(store, vendorFeatureStore, authorizationCategoryFeatureStore, authorizationTypeFeatureStore, procedureFeatureStore) {
    this.store = store;
    this.vendorFeatureStore = vendorFeatureStore;
    this.authorizationCategoryFeatureStore = authorizationCategoryFeatureStore;
    this.authorizationTypeFeatureStore = authorizationTypeFeatureStore;
    ...
    this.columnDefs = [{
      ...
      field: 'authorizationCategory.name',
      headerName: 'Authorization Category',
      filter: 'agTextColumnFilter'
    }, {
      field: 'authorizationType.name',
        ...
        case 'authorizationCategory':
          {
            ...
            this.authorizationCategoryFeatureStore.createAuthorizationCategoryEffect({
              name: newName
            });
            break;
          }
        case 'authorizationType':
          {
            ...
            this.authorizationTypeFeatureStore.createAuthorizationTypeEffect({
              name: newName
            });
            break;
          }
...
WebAuthorizationListComponent.ɵfac = function WebAuthorizationListComponent_Factory(t) {
  return new (t || WebAuthorizationListComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_case_clinical_web_authorization_shared__WEBPACK_IMPORTED_MODULE_3__.WebAuthorizationFeatureStore), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_case_clinical_web_vendor_shared__WEBPACK_IMPORTED_MODULE_4__.WebVendorFeatureStore), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_case_clinical_web_authorization_category_shared__WEBPACK_IMPORTED_MODULE_5__.WebAuthorizationCategoryFeatureStore), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_case_clinical_web_authorization_type_shared__WEBPACK_IMPORTED_MODULE_6__.WebAuthorizationTypeFeatureStore), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_case_clinical_web_procedure_shared__WEBPACK_IMPORTED_MODULE_7__.WebProcedureFeatureStore));
};
WebAuthorizationListComponent.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
  type: WebAuthorizationListComponent,
  selectors: [["ng-component"]],
  viewQuery: function WebAuthorizationListComponent_Query(rf, ctx) {
    if (rf & 1) {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵviewQuery"](_case_clinical_web_authorization_ui__WEBPACK_IMPORTED_MODULE_8__.WebAuthorizationSelectTableViewComponent, 5);
    }
    if (rf & 2) {
      let _t;
  ...
  features: [_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵProvidersFeature"]([_case_clinical_web_authorization_shared__WEBPACK_IMPORTED_MODULE_3__.WebAuthorizationFeatureStore, _case_clinical_web_vendor_shared__WEBPACK_IMPORTED_MODULE_4__.WebVendorFeatureStore, _case_clinical_web_authorization_category_shared__WEBPACK_IMPORTED_MODULE_5__.WebAuthorizationCategoryFeatureStore, _case_clinical_web_authorization_type_shared__WEBPACK_IMPORTED_MODULE_6__.WebAuthorizationTypeFeatureStore, _case_clinical_web_procedure_shared__WEBPACK_IMPORTED_MODULE_7__.WebProcedureFeatureStore])],
  decls: 1,
  vars: 1,
  consts: [[4, "featureFlag"], [4, "ngIf"], ["tableName", "authorization", "title", "Authorization", 1, "h-full", "w-full", 3, "data", "columnDefs", "validateFunc", "createNewFunc", "searchQueryDidChange", "excelDataHasBeenPopulated"]],
  template: function WebAuthorizationListComponent_Template(rf, ctx) {
    if (rf & 1) {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](0, WebAuthorizationListComponent_ng_container_0_Template, 3, 3, "ng-container", 0);
    }
    if (rf & 2) {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("featureFlag", "Authorization.View");
    }
  },
...
/***/ 526828:
/*!********************************************************************************************************!*\
  !*** ./libs/web/authorization/feature/src/lib/web-authorization-list/web-authorization-list.module.ts ***!
  \********************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "WebAuthorizationListModule": () => (/* binding */ WebAuthorizationListModule)
/* harmony export */ });
...
/* harmony import */ var _web_authorization_list_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./web-authorization-list.component */ 795277);
...
class WebAuthorizationListModule {}
WebAuthorizationListModule.ɵfac = function WebAuthorizationListModule_Factory(t) {
  return new (t || WebAuthorizationListModule)();
};
WebAuthorizationListModule.ɵmod = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineNgModule"]({
  type: WebAuthorizationListModule
});
WebAuthorizationListModule.ɵinj = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
  imports: [_angular_common__WEBPACK_IMPORTED_MODULE_1__.CommonModule, _angular_router__WEBPACK_IMPORTED_MODULE_2__.RouterModule.forChild([{
    path: '',
    component: _web_authorization_list_component__WEBPACK_IMPORTED_MODULE_3__.WebAuthorizationListComponent
...
(function () {
  (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](WebAuthorizationListModule, {
    declarations: [_web_authorization_list_component__WEBPACK_IMPORTED_MODULE_3__.WebAuthorizationListComponent],
...
/***/ 948308:
/*!******************************************************************************************************************!*\
  !*** ./libs/web/authorization/ui/web-authorization-select-form/web-authorization-select-table-view.component.ts ***!
  \******************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "WebAuthorizationSelectTableViewComponent": () => (/* binding */ WebAuthorizationSelectTableViewComponent)
/* harmony export */ });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ 94650);
/* harmony import */ var _case_clinical_web_core_data_access__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @case-clinical/web/core/data-access */ 251645);
...
class WebAuthorizationSelectTableViewComponent {
  constructor() {
    ...
    this.columnDefs = [{
      ...
      valueFormatter: params => {
        var _a;
        return (0,_case_clinical_web_core_data_access__WEBPACK_IMPORTED_MODULE_1__.currencyFormatter)((_a = params.data) === null || _a === void 0 ? void 0 : _a.durationOrQuantity, '$', 2);
      },
      filter: 'agNumberColumnFilter',
      aggFunc: 'sum'
    }, {
...
WebAuthorizationSelectTableViewComponent.ɵfac = function WebAuthorizationSelectTableViewComponent_Factory(t) {
  return new (t || WebAuthorizationSelectTableViewComponent)();
};
WebAuthorizationSelectTableViewComponent.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
  type: WebAuthorizationSelectTableViewComponent,
  selectors: [["ui-authorization-select-table-view"]],
  viewQuery: function WebAuthorizationSelectTableViewComponent_Query(rf, ctx) {
    if (rf & 1) {
  ...
  template: function WebAuthorizationSelectTableViewComponent_Template(rf, ctx) {
    if (rf & 1) {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "table-view", 0);
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("itemDidSelect", function WebAuthorizationSelectTableViewComponent_Template_table_view_itemDidSelect_0_listener($event) {
        return ctx.onSelected($event);
      })("selectionDidChange", function WebAuthorizationSelectTableViewComponent_Template_table_view_selectionDidChange_0_listener($event) {
        return ctx.selectionDidChange($event);
      });
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
    }
    if (rf & 2) {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("autoHeight", ctx.autoHeight)("data", ctx.authorizations)("showSidebar", false)("suppressRowClickSelection", false)("columnDefs", ctx.columnDefs);
    }
  },
