"use strict";
(self["webpackChunkweb"] = self["webpackChunkweb"] || []).push([["libs_web_contact-setting_feature_src_lib_web-contact-setting-list_web-contact-setting-list_mo-9d1e84"],{

/***/ 232300:
/*!*****************************************************************************************************************!*\
  !*** ./libs/web/contact-setting/feature/src/lib/web-contact-setting-list/web-contact-setting-list.component.ts ***!
  \*****************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "WebContactSettingListComponent": () => (/* binding */ WebContactSettingListComponent)
/* harmony export */ });
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! rxjs */ 469751);
/* harmony import */ var _case_clinical_web_core_data_access__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @case-clinical/web/core/data-access */ 251645);
/* harmony import */ var _case_clinical_web_contact_setting_shared__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @case-clinical/web/contact-setting/shared */ 591068);
/* harmony import */ var _case_clinical_web_contact_setting_ui__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @case-clinical/web/contact-setting/ui */ 558715);
...
/* harmony import */ var _case_clinical_web_integration_shared__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @case-clinical/web/integration/shared */ 776305);
...
function WebContactSettingListComponent_ng_container_0_ng_container_1_Template(rf, ctx) {
  if (rf & 1) {
    const _r4 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementContainerStart"](0);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](1, "ui-data-list", 2);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("searchQueryDidChange", function WebContactSettingListComponent_ng_container_0_ng_container_1_Template_ui_data_list_searchQueryDidChange_1_listener($event) {
    ...
    })("excelDataHasBeenPopulated", function WebContactSettingListComponent_ng_container_0_ng_container_1_Template_ui_data_list_excelDataHasBeenPopulated_1_listener($event) {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r4);
  ...
  if (rf & 2) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("data", vm_r2.contactSettings)("columnDefs", ctx_r1.columnDefs)("validateFunc", ctx_r1.validateImportData)("createNewFunc", ctx_r1.createNewFunc);
  }
}
function WebContactSettingListComponent_ng_container_0_Template(rf, ctx) {
  if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementContainerStart"](0);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](1, WebContactSettingListComponent_ng_container_0_ng_container_1_Template, 2, 4, "ng-container", 1);
...
class WebContactSettingListComponent {
  constructor(store, contactFeatureStore, integrationFeatureStore) {
    this.store = store;
    this.contactFeatureStore = contactFeatureStore;
    this.integrationFeatureStore = integrationFeatureStore;
        ...
        case 'integration':
          {
            ...
            this.integrationFeatureStore.createIntegrationEffect({
              name: newName
            });
            break;
          }
...
WebContactSettingListComponent.ɵfac = function WebContactSettingListComponent_Factory(t) {
  return new (t || WebContactSettingListComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_case_clinical_web_contact_setting_shared__WEBPACK_IMPORTED_MODULE_3__.WebContactSettingFeatureStore), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_case_clinical_web_contact_shared__WEBPACK_IMPORTED_MODULE_4__.WebContactFeatureStore), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_case_clinical_web_integration_shared__WEBPACK_IMPORTED_MODULE_5__.WebIntegrationFeatureStore));
};
WebContactSettingListComponent.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
  type: WebContactSettingListComponent,
  selectors: [["ng-component"]],
  viewQuery: function WebContactSettingListComponent_Query(rf, ctx) {
    if (rf & 1) {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵviewQuery"](_case_clinical_web_contact_setting_ui__WEBPACK_IMPORTED_MODULE_6__.WebContactSettingSelectTableViewComponent, 5);
    }
    if (rf & 2) {
      let _t;
  ...
  features: [_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵProvidersFeature"]([_case_clinical_web_contact_setting_shared__WEBPACK_IMPORTED_MODULE_3__.WebContactSettingFeatureStore, _case_clinical_web_contact_shared__WEBPACK_IMPORTED_MODULE_4__.WebContactFeatureStore, _case_clinical_web_integration_shared__WEBPACK_IMPORTED_MODULE_5__.WebIntegrationFeatureStore])],
  decls: 1,
  vars: 1,
  consts: [[4, "featureFlag"], [4, "ngIf"], ["tableName", "contactSetting", "title", "ContactSetting", 1, "h-full", "w-full", 3, "data", "columnDefs", "validateFunc", "createNewFunc", "searchQueryDidChange", "excelDataHasBeenPopulated"]],
  template: function WebContactSettingListComponent_Template(rf, ctx) {
    if (rf & 1) {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](0, WebContactSettingListComponent_ng_container_0_Template, 3, 3, "ng-container", 0);
    }
    if (rf & 2) {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("featureFlag", "ContactSetting.View");
    }
  },
...
/***/ 742215:
/*!**************************************************************************************************************!*\
  !*** ./libs/web/contact-setting/feature/src/lib/web-contact-setting-list/web-contact-setting-list.module.ts ***!
  \**************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "WebContactSettingListModule": () => (/* binding */ WebContactSettingListModule)
/* harmony export */ });
...
/* harmony import */ var _web_contact_setting_list_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./web-contact-setting-list.component */ 232300);
...
class WebContactSettingListModule {}
WebContactSettingListModule.ɵfac = function WebContactSettingListModule_Factory(t) {
  return new (t || WebContactSettingListModule)();
};
WebContactSettingListModule.ɵmod = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineNgModule"]({
  type: WebContactSettingListModule
});
WebContactSettingListModule.ɵinj = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
  imports: [_angular_common__WEBPACK_IMPORTED_MODULE_1__.CommonModule, _angular_router__WEBPACK_IMPORTED_MODULE_2__.RouterModule.forChild([{
    path: '',
    component: _web_contact_setting_list_component__WEBPACK_IMPORTED_MODULE_3__.WebContactSettingListComponent
...
(function () {
  (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](WebContactSettingListModule, {
    declarations: [_web_contact_setting_list_component__WEBPACK_IMPORTED_MODULE_3__.WebContactSettingListComponent],
