"use strict";
(self["webpackChunkweb"] = self["webpackChunkweb"] || []).push([["libs_web_authorization-kind_feature_src_lib_web-authorization-kind-list_web-authorization-kin-1a44e6"],{

/***/ 431331:
/*!**************************************************************************************************************************!*\
  !*** ./libs/web/authorization-kind/feature/src/lib/web-authorization-kind-list/web-authorization-kind-list.component.ts ***!
  \**************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "WebAuthorizationKindListComponent": () => (/* binding */ WebAuthorizationKindListComponent)
/* harmony export */ });
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! rxjs */ 469751);
/* harmony import */ var _case_clinical_web_core_data_access__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @case-clinical/web/core/data-access */ 251645);
/* harmony import */ var _case_clinical_web_authorization_kind_shared__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @case-clinical/web/authorization-kind/shared */ 154500);
/* harmony import */ var _case_clinical_web_authorization_kind_ui__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @case-clinical/web/authorization-kind/ui */ 346964);
/* harmony import */ var _case_clinical_web_category_shared__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @case-clinical/web/category/shared */ 669145);
...
function WebAuthorizationKindListComponent_ng_container_0_ng_container_1_Template(rf, ctx) {
  if (rf & 1) {
    const _r4 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementContainerStart"](0);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](1, "ui-data-list", 2);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("searchQueryDidChange", function WebAuthorizationKindListComponent_ng_container_0_ng_container_1_Template_ui_data_list_searchQueryDidChange_1_listener($event) {
    ...
    })("excelDataHasBeenPopulated", function WebAuthorizationKindListComponent_ng_container_0_ng_container_1_Template_ui_data_list_excelDataHasBeenPopulated_1_listener($event) {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r4);
  ...
  if (rf & 2) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("data", vm_r2.authorizationKinds)("columnDefs", ctx_r1.columnDefs)("validateFunc", ctx_r1.validateImportData)("createNewFunc", ctx_r1.createNewFunc);
  }
}
function WebAuthorizationKindListComponent_ng_container_0_Template(rf, ctx) {
  if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementContainerStart"](0);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](1, WebAuthorizationKindListComponent_ng_container_0_ng_container_1_Template, 2, 4, "ng-container", 1);
...
class WebAuthorizationKindListComponent {
  constructor(store, categoryFeatureStore) {
    this.store = store;
    this.categoryFeatureStore = categoryFeatureStore;
  ...
  createNewFunc(type, newName) {
    return new rxjs__WEBPACK_IMPORTED_MODULE_2__.Observable(observer => {
      switch (type) {
        case 'category':
          {
            const categoryCreateActionResultListener = this.categoryFeatureStore.actionResult$.subscribe(result => {
              if (result.done) {
                this.store.addCategory(result.item);
                setTimeout(() => {
                  observer.next(true);
                  observer.complete();
                }, 300);
                categoryCreateActionResultListener.unsubscribe();
              }
            });
            this.categoryFeatureStore.createCategoryEffect({
              name: newName
            });
            break;
          }
...
WebAuthorizationKindListComponent.ɵfac = function WebAuthorizationKindListComponent_Factory(t) {
  return new (t || WebAuthorizationKindListComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_case_clinical_web_authorization_kind_shared__WEBPACK_IMPORTED_MODULE_3__.WebAuthorizationKindFeatureStore), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_case_clinical_web_category_shared__WEBPACK_IMPORTED_MODULE_4__.WebCategoryFeatureStore));
};
WebAuthorizationKindListComponent.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
  type: WebAuthorizationKindListComponent,
  selectors: [["ng-component"]],
  viewQuery: function WebAuthorizationKindListComponent_Query(rf, ctx) {
    if (rf & 1) {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵviewQuery"](_case_clinical_web_authorization_kind_ui__WEBPACK_IMPORTED_MODULE_5__.WebAuthorizationKindSelectTableViewComponent, 5);
    }
    if (rf & 2) {
      let _t;
  ...
  features: [_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵProvidersFeature"]([_case_clinical_web_authorization_kind_shared__WEBPACK_IMPORTED_MODULE_3__.WebAuthorizationKindFeatureStore, _case_clinical_web_category_shared__WEBPACK_IMPORTED_MODULE_4__.WebCategoryFeatureStore])],
  decls: 1,
  vars: 1,
  consts: [[4, "featureFlag"], [4, "ngIf"], ["tableName", "authorizationKind", "title", "AuthorizationKind", 1, "h-full", "w-full", 3, "data", "columnDefs", "validateFunc", "createNewFunc", "searchQueryDidChange", "excelDataHasBeenPopulated"]],
  template: function WebAuthorizationKindListComponent_Template(rf, ctx) {
    if (rf & 1) {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](0, WebAuthorizationKindListComponent_ng_container_0_Template, 3, 3, "ng-container", 0);
    }
    if (rf & 2) {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("featureFlag", "AuthorizationKind.View");
    }
  },
...
/***/ 88407:
/*!***********************************************************************************************************************!*\
  !*** ./libs/web/authorization-kind/feature/src/lib/web-authorization-kind-list/web-authorization-kind-list.module.ts ***!
  \***********************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "WebAuthorizationKindListModule": () => (/* binding */ WebAuthorizationKindListModule)
/* harmony export */ });
...
/* harmony import */ var _web_authorization_kind_list_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./web-authorization-kind-list.component */ 431331);
...
class WebAuthorizationKindListModule {}
WebAuthorizationKindListModule.ɵfac = function WebAuthorizationKindListModule_Factory(t) {
  return new (t || WebAuthorizationKindListModule)();
};
WebAuthorizationKindListModule.ɵmod = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineNgModule"]({
  type: WebAuthorizationKindListModule
});
WebAuthorizationKindListModule.ɵinj = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
  imports: [_angular_common__WEBPACK_IMPORTED_MODULE_1__.CommonModule, _angular_router__WEBPACK_IMPORTED_MODULE_2__.RouterModule.forChild([{
    path: '',
    component: _web_authorization_kind_list_component__WEBPACK_IMPORTED_MODULE_3__.WebAuthorizationKindListComponent
...
(function () {
  (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](WebAuthorizationKindListModule, {
    declarations: [_web_authorization_kind_list_component__WEBPACK_IMPORTED_MODULE_3__.WebAuthorizationKindListComponent],
...
/***/ 346964:
/*!*********************************************************************************************************************************!*\
  !*** ./libs/web/authorization-kind/ui/web-authorization-kind-select-form/web-authorization-kind-select-table-view.component.ts ***!
  \*********************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "WebAuthorizationKindSelectTableViewComponent": () => (/* binding */ WebAuthorizationKindSelectTableViewComponent)
/* harmony export */ });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ 94650);
/* harmony import */ var _case_clinical_web_core_data_access__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @case-clinical/web/core/data-access */ 251645);
...
class WebAuthorizationKindSelectTableViewComponent {
  constructor() {
...
WebAuthorizationKindSelectTableViewComponent.ɵfac = function WebAuthorizationKindSelectTableViewComponent_Factory(t) {
  return new (t || WebAuthorizationKindSelectTableViewComponent)();
};
WebAuthorizationKindSelectTableViewComponent.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
  type: WebAuthorizationKindSelectTableViewComponent,
  selectors: [["ui-authorization-kind-select-table-view"]],
  viewQuery: function WebAuthorizationKindSelectTableViewComponent_Query(rf, ctx) {
    if (rf & 1) {
  ...
  inputs: {
    ...
    authorizationKinds: "authorizationKinds"
  },
  outputs: {
  ...
  template: function WebAuthorizationKindSelectTableViewComponent_Template(rf, ctx) {
    if (rf & 1) {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "table-view", 0);
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("itemDidSelect", function WebAuthorizationKindSelectTableViewComponent_Template_table_view_itemDidSelect_0_listener($event) {
        return ctx.onSelected($event);
      })("selectionDidChange", function WebAuthorizationKindSelectTableViewComponent_Template_table_view_selectionDidChange_0_listener($event) {
        return ctx.selectionDidChange($event);
      });
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
    }
    if (rf & 2) {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("autoHeight", ctx.autoHeight)("showSidebar", false)("data", ctx.authorizationKinds)("suppressRowClickSelection", false)("columnDefs", ctx.columnDefs);
    }
  },
