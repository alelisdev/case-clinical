"use strict";
(self["webpackChunkweb"] = self["webpackChunkweb"] || []).push([["libs_web_case-type_feature_src_lib_web-case-type-detail_web-case-type-detail_module_ts"],{

/***/ 201466:
/*!************************************************************************************************!*\
  !*** ./libs/web/case-type/feature/src/lib/web-case-type-detail/overview/overview.component.ts ***!
  \************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "WebCaseTypeOverviewComponent": () => (/* binding */ WebCaseTypeOverviewComponent)
/* harmony export */ });
/* harmony import */ var _case_clinical_web_case_type_shared__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @case-clinical/web/case-type/shared */ 447024);
...
function WebCaseTypeOverviewComponent_ng_container_0_ng_container_1_Template(rf, ctx) {
  if (rf & 1) {
...
function WebCaseTypeOverviewComponent_ng_container_0_Template(rf, ctx) {
  if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementContainerStart"](0);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](1, WebCaseTypeOverviewComponent_ng_container_0_ng_container_1_Template, 2, 3, "ng-container", 0);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementContainerEnd"]();
  }
  if (rf & 2) {
...
class WebCaseTypeOverviewComponent {
  ...
  ngOnInit() {
    this.store.loadCaseTypeEffect(this.route.params.pipe((0,rxjs__WEBPACK_IMPORTED_MODULE_1__.pluck)('caseTypeId')));
  ...
  deleteItem(item) {
    if (confirm('Are you sure?')) {
      this.store.deleteCaseTypeEffect();
    }
  }
  legalCaseAdded($event) {
    console.log('from the overview in Case Type, added: ', $event);
  }
}
WebCaseTypeOverviewComponent.ɵfac = function WebCaseTypeOverviewComponent_Factory(t) {
  return new (t || WebCaseTypeOverviewComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_case_clinical_web_case_type_shared__WEBPACK_IMPORTED_MODULE_2__.WebCaseTypeFeatureStore), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_3__.Router), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_3__.ActivatedRoute));
};
WebCaseTypeOverviewComponent.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
  type: WebCaseTypeOverviewComponent,
  selectors: [["ng-component"]],
  features: [_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵProvidersFeature"]([_case_clinical_web_case_type_shared__WEBPACK_IMPORTED_MODULE_2__.WebCaseTypeFeatureStore])],
  decls: 2,
  vars: 3,
  consts: [[4, "ngIf"], ["formName", "caseType_overview", 3, "showSubmitButton", "componentStore", "model"]],
  template: function WebCaseTypeOverviewComponent_Template(rf, ctx) {
    if (rf & 1) {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](0, WebCaseTypeOverviewComponent_ng_container_0_Template, 2, 1, "ng-container", 0);
...
/***/ 36895:
/*!***************************************************************************************************!*\
  !*** ./libs/web/case-type/feature/src/lib/web-case-type-detail/web-case-type-detail.component.ts ***!
  \***************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "WebCaseTypeDetailComponent": () => (/* binding */ WebCaseTypeDetailComponent)
/* harmony export */ });
/* harmony import */ var _web_case_type_detail_store__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./web-case-type-detail.store */ 459377);
...
const _c0 = ["matDrawer"];
class WebCaseTypeDetailComponent {
  ...
  deleteItem(item) {
    if (confirm('Are you sure?')) {
      this.store.deleteCaseTypeEffect(item);
    }
  }
}
WebCaseTypeDetailComponent.ɵfac = function WebCaseTypeDetailComponent_Factory(t) {
  return new (t || WebCaseTypeDetailComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdirectiveInject"](_web_case_type_detail_store__WEBPACK_IMPORTED_MODULE_4__.WebCaseTypeDetailStore), _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_5__.ActivatedRoute), _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdirectiveInject"](_angular_core__WEBPACK_IMPORTED_MODULE_3__.ChangeDetectorRef), _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdirectiveInject"](_fuse_services_media_watcher__WEBPACK_IMPORTED_MODULE_6__.FuseMediaWatcherService));
};
WebCaseTypeDetailComponent.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdefineComponent"]({
  type: WebCaseTypeDetailComponent,
  selectors: [["ng-component"]],
  viewQuery: function WebCaseTypeDetailComponent_Query(rf, ctx) {
    if (rf & 1) {
  ...
  features: [_angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵProvidersFeature"]([_web_case_type_detail_store__WEBPACK_IMPORTED_MODULE_4__.WebCaseTypeDetailStore])],
  decls: 10,
  vars: 9,
  ...
  template: function WebCaseTypeDetailComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵlistener"]("click", function WebCaseTypeDetailComponent_Template_button_click_8_listener() {
...
/***/ 398536:
/*!************************************************************************************************!*\
  !*** ./libs/web/case-type/feature/src/lib/web-case-type-detail/web-case-type-detail.module.ts ***!
  \************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "WebCaseTypeDetailModule": () => (/* binding */ WebCaseTypeDetailModule)
/* harmony export */ });
...
/* harmony import */ var _web_case_type_detail_component__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ./web-case-type-detail.component */ 36895);
/* harmony import */ var _overview_overview_component__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ./overview/overview.component */ 201466);
...
class WebCaseTypeDetailModule {}
WebCaseTypeDetailModule.ɵfac = function WebCaseTypeDetailModule_Factory(t) {
  return new (t || WebCaseTypeDetailModule)();
};
WebCaseTypeDetailModule.ɵmod = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineNgModule"]({
  type: WebCaseTypeDetailModule
});
WebCaseTypeDetailModule.ɵinj = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
  imports: [_angular_material_button__WEBPACK_IMPORTED_MODULE_1__.MatButtonModule, _angular_material_icon__WEBPACK_IMPORTED_MODULE_2__.MatIconModule, _angular_material_sidenav__WEBPACK_IMPORTED_MODULE_3__.MatSidenavModule, _angular_material_tree__WEBPACK_IMPORTED_MODULE_4__.MatTreeModule, _fuse_components_highlight__WEBPACK_IMPORTED_MODULE_5__.FuseHighlightModule, _fuse_components_alert__WEBPACK_IMPORTED_MODULE_6__.FuseAlertModule, _fuse_components_navigation__WEBPACK_IMPORTED_MODULE_7__.FuseNavigationModule, _fuse_directives_scroll_reset__WEBPACK_IMPORTED_MODULE_8__.FuseScrollResetModule, libs_shared_shared_module__WEBPACK_IMPORTED_MODULE_9__.SharedModule, _angular_common__WEBPACK_IMPORTED_MODULE_10__.CommonModule, _case_clinical_web_ui_panel__WEBPACK_IMPORTED_MODULE_11__.WebUiPanelModule, _case_clinical_web_ui_description_list__WEBPACK_IMPORTED_MODULE_12__.WebUiDescriptionListModule, _case_clinical_web_ui_card_header__WEBPACK_IMPORTED_MODULE_13__.WebUiCardHeaderModule, _case_clinical_web_ui_page__WEBPACK_IMPORTED_MODULE_14__.WebUiPageModule, _case_clinical_web_shared_ui__WEBPACK_IMPORTED_MODULE_15__.UtilitySharedModule, _case_clinical_web_shared_ui__WEBPACK_IMPORTED_MODULE_16__.UiFormsSharedModule, _case_clinical_web_core_feature__WEBPACK_IMPORTED_MODULE_17__.WebCoreFeatureModule, _case_clinical_web_ui_formly_designer__WEBPACK_IMPORTED_MODULE_18__.WebUiFormlyDesignerModule, _angular_router__WEBPACK_IMPORTED_MODULE_19__.RouterModule.forChild([{
    path: '',
    component: _web_case_type_detail_component__WEBPACK_IMPORTED_MODULE_20__.WebCaseTypeDetailComponent,
    children: [{
      path: 'overview',
      pathMatch: 'full',
      component: _overview_overview_component__WEBPACK_IMPORTED_MODULE_21__.WebCaseTypeOverviewComponent
    }, {
      path: 'edit',
      loadChildren: () => __webpack_require__.e(/*! import() */ "libs_web_case-type_feature_src_lib_web-case-type-edit_web-case-type-edit_module_ts").then(__webpack_require__.bind(__webpack_require__, /*! ../web-case-type-edit/web-case-type-edit.module */ 394044)).then(m => m.WebCaseTypeEditModule)
    }, {
      path: 'legal-cases',
...
(function () {
  (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](WebCaseTypeDetailModule, {
    declarations: [_web_case_type_detail_component__WEBPACK_IMPORTED_MODULE_20__.WebCaseTypeDetailComponent, _overview_overview_component__WEBPACK_IMPORTED_MODULE_21__.WebCaseTypeOverviewComponent],
...
/***/ 459377:
/*!***********************************************************************************************!*\
  !*** ./libs/web/case-type/feature/src/lib/web-case-type-detail/web-case-type-detail.store.ts ***!
  \***********************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "WebCaseTypeDetailStore": () => (/* binding */ WebCaseTypeDetailStore)
/* harmony export */ });
...
class WebCaseTypeDetailStore extends _ngrx_component_store__WEBPACK_IMPORTED_MODULE_0__.ComponentStore {
  constructor(data, router, route, toast) {
    ...
    this.loadCaseTypeEffect = this.effect(caseTypeId$ => caseTypeId$.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_1__.tap)(() => this.setState({
      loading: true
    ...
    this.deleteCaseTypeEffect = this.effect(caseType$ => caseType$.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.switchMap)(caseType => this.data.userDeleteCaseType({
