"use strict";
(self["webpackChunkweb"] = self["webpackChunkweb"] || []).push([["libs_web_bank_feature_src_lib_web-bank-detail_web-bank-detail_module_ts"],{

/***/ 250503:
/*!**************************************************************************************!*\
  !*** ./libs/web/bank/feature/src/lib/web-bank-detail/overview/overview.component.ts ***!
  \**************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "WebBankOverviewComponent": () => (/* binding */ WebBankOverviewComponent)
/* harmony export */ });
/* harmony import */ var _case_clinical_web_bank_shared__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @case-clinical/web/bank/shared */ 493702);
...
function WebBankOverviewComponent_ng_container_0_ng_container_1_Template(rf, ctx) {
  if (rf & 1) {
...
function WebBankOverviewComponent_ng_container_0_Template(rf, ctx) {
  if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementContainerStart"](0);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](1, WebBankOverviewComponent_ng_container_0_ng_container_1_Template, 2, 3, "ng-container", 0);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementContainerEnd"]();
  }
  if (rf & 2) {
...
class WebBankOverviewComponent {
  ...
  ngOnInit() {
    this.store.loadBankEffect(this.route.params.pipe((0,rxjs__WEBPACK_IMPORTED_MODULE_1__.pluck)('bankId')));
  ...
  deleteItem(item) {
    if (confirm('Are you sure?')) {
      this.store.deleteBankEffect();
    }
  }
  paymentAdded($event) {
    console.log('from the overview in Bank, added: ', $event);
  }
}
WebBankOverviewComponent.ɵfac = function WebBankOverviewComponent_Factory(t) {
  return new (t || WebBankOverviewComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_case_clinical_web_bank_shared__WEBPACK_IMPORTED_MODULE_2__.WebBankFeatureStore), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_3__.Router), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_3__.ActivatedRoute));
};
WebBankOverviewComponent.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
  type: WebBankOverviewComponent,
  selectors: [["ng-component"]],
  features: [_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵProvidersFeature"]([_case_clinical_web_bank_shared__WEBPACK_IMPORTED_MODULE_2__.WebBankFeatureStore])],
  decls: 2,
  vars: 3,
  consts: [[4, "ngIf"], ["formName", "bank_overview", 3, "showSubmitButton", "componentStore", "model"]],
  template: function WebBankOverviewComponent_Template(rf, ctx) {
    if (rf & 1) {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](0, WebBankOverviewComponent_ng_container_0_Template, 2, 1, "ng-container", 0);
...
/***/ 709422:
/*!************************************************************************************!*\
  !*** ./libs/web/bank/feature/src/lib/web-bank-detail/web-bank-detail.component.ts ***!
  \************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "WebBankDetailComponent": () => (/* binding */ WebBankDetailComponent)
/* harmony export */ });
/* harmony import */ var _web_bank_detail_store__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./web-bank-detail.store */ 606341);
...
class WebBankDetailComponent {
  ...
  deleteItem(item) {
    if (confirm('Are you sure?')) {
      this.store.deleteBankEffect(item);
    }
  }
}
WebBankDetailComponent.ɵfac = function WebBankDetailComponent_Factory(t) {
  return new (t || WebBankDetailComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdirectiveInject"](_web_bank_detail_store__WEBPACK_IMPORTED_MODULE_4__.WebBankDetailStore), _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_5__.ActivatedRoute), _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdirectiveInject"](_angular_core__WEBPACK_IMPORTED_MODULE_3__.ChangeDetectorRef), _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdirectiveInject"](_fuse_services_media_watcher__WEBPACK_IMPORTED_MODULE_6__.FuseMediaWatcherService));
};
WebBankDetailComponent.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdefineComponent"]({
  type: WebBankDetailComponent,
  selectors: [["ng-component"]],
  viewQuery: function WebBankDetailComponent_Query(rf, ctx) {
    if (rf & 1) {
  ...
  features: [_angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵProvidersFeature"]([_web_bank_detail_store__WEBPACK_IMPORTED_MODULE_4__.WebBankDetailStore])],
  decls: 10,
  vars: 9,
  ...
  template: function WebBankDetailComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵlistener"]("click", function WebBankDetailComponent_Template_button_click_8_listener() {
...
/***/ 991449:
/*!*********************************************************************************!*\
  !*** ./libs/web/bank/feature/src/lib/web-bank-detail/web-bank-detail.module.ts ***!
  \*********************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "WebBankDetailModule": () => (/* binding */ WebBankDetailModule)
/* harmony export */ });
...
/* harmony import */ var _web_bank_detail_component__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ./web-bank-detail.component */ 709422);
/* harmony import */ var _overview_overview_component__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ./overview/overview.component */ 250503);
...
class WebBankDetailModule {}
WebBankDetailModule.ɵfac = function WebBankDetailModule_Factory(t) {
  return new (t || WebBankDetailModule)();
};
WebBankDetailModule.ɵmod = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineNgModule"]({
  type: WebBankDetailModule
});
WebBankDetailModule.ɵinj = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
  imports: [_angular_material_button__WEBPACK_IMPORTED_MODULE_1__.MatButtonModule, _angular_material_icon__WEBPACK_IMPORTED_MODULE_2__.MatIconModule, _angular_material_sidenav__WEBPACK_IMPORTED_MODULE_3__.MatSidenavModule, _angular_material_tree__WEBPACK_IMPORTED_MODULE_4__.MatTreeModule, _fuse_components_highlight__WEBPACK_IMPORTED_MODULE_5__.FuseHighlightModule, _fuse_components_alert__WEBPACK_IMPORTED_MODULE_6__.FuseAlertModule, _fuse_components_navigation__WEBPACK_IMPORTED_MODULE_7__.FuseNavigationModule, _fuse_directives_scroll_reset__WEBPACK_IMPORTED_MODULE_8__.FuseScrollResetModule, libs_shared_shared_module__WEBPACK_IMPORTED_MODULE_9__.SharedModule, _angular_common__WEBPACK_IMPORTED_MODULE_10__.CommonModule, _case_clinical_web_ui_panel__WEBPACK_IMPORTED_MODULE_11__.WebUiPanelModule, _case_clinical_web_ui_description_list__WEBPACK_IMPORTED_MODULE_12__.WebUiDescriptionListModule, _case_clinical_web_ui_card_header__WEBPACK_IMPORTED_MODULE_13__.WebUiCardHeaderModule, _case_clinical_web_ui_page__WEBPACK_IMPORTED_MODULE_14__.WebUiPageModule, _case_clinical_web_shared_ui__WEBPACK_IMPORTED_MODULE_15__.UtilitySharedModule, _case_clinical_web_shared_ui__WEBPACK_IMPORTED_MODULE_16__.UiFormsSharedModule, _case_clinical_web_core_feature__WEBPACK_IMPORTED_MODULE_17__.WebCoreFeatureModule, _case_clinical_web_ui_formly_designer__WEBPACK_IMPORTED_MODULE_18__.WebUiFormlyDesignerModule, _angular_router__WEBPACK_IMPORTED_MODULE_19__.RouterModule.forChild([{
    path: '',
    component: _web_bank_detail_component__WEBPACK_IMPORTED_MODULE_20__.WebBankDetailComponent,
    children: [{
      path: 'overview',
      pathMatch: 'full',
      component: _overview_overview_component__WEBPACK_IMPORTED_MODULE_21__.WebBankOverviewComponent
    }, {
      path: 'edit',
      loadChildren: () => __webpack_require__.e(/*! import() */ "libs_web_bank_feature_src_lib_web-bank-edit_web-bank-edit_module_ts").then(__webpack_require__.bind(__webpack_require__, /*! ../web-bank-edit/web-bank-edit.module */ 347857)).then(m => m.WebBankEditModule)
    }, {
      path: 'payments',
...
(function () {
  (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](WebBankDetailModule, {
    declarations: [_web_bank_detail_component__WEBPACK_IMPORTED_MODULE_20__.WebBankDetailComponent, _overview_overview_component__WEBPACK_IMPORTED_MODULE_21__.WebBankOverviewComponent],
...
/***/ 606341:
/*!********************************************************************************!*\
  !*** ./libs/web/bank/feature/src/lib/web-bank-detail/web-bank-detail.store.ts ***!
  \********************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "WebBankDetailStore": () => (/* binding */ WebBankDetailStore)
/* harmony export */ });
...
class WebBankDetailStore extends _ngrx_component_store__WEBPACK_IMPORTED_MODULE_0__.ComponentStore {
  constructor(data, router, route, toast) {
    ...
    this.loadBankEffect = this.effect(bankId$ => bankId$.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_1__.tap)(() => this.setState({
      loading: true
    ...
    this.deleteBankEffect = this.effect(bank$ => bank$.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.switchMap)(bank => this.data.userDeleteBank({
      bankId: bank.id
