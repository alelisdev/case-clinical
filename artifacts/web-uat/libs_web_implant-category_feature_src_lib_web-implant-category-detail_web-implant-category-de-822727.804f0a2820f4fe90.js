"use strict";
(self["webpackChunkweb"] = self["webpackChunkweb"] || []).push([["libs_web_implant-category_feature_src_lib_web-implant-category-detail_web-implant-category-de-822727"],{

/***/ 369585:
/*!**************************************************************************************************************!*\
  !*** ./libs/web/implant-category/feature/src/lib/web-implant-category-detail/overview/overview.component.ts ***!
  \**************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "WebImplantCategoryOverviewComponent": () => (/* binding */ WebImplantCategoryOverviewComponent)
/* harmony export */ });
/* harmony import */ var _case_clinical_web_implant_category_shared__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @case-clinical/web/implant-category/shared */ 291237);
...
function WebImplantCategoryOverviewComponent_ng_container_0_ng_container_1_Template(rf, ctx) {
  if (rf & 1) {
...
function WebImplantCategoryOverviewComponent_ng_container_0_Template(rf, ctx) {
  if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementContainerStart"](0);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](1, WebImplantCategoryOverviewComponent_ng_container_0_ng_container_1_Template, 2, 3, "ng-container", 0);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementContainerEnd"]();
  }
  if (rf & 2) {
...
class WebImplantCategoryOverviewComponent {
  ...
  ngOnInit() {
    this.store.loadImplantCategoryEffect(this.route.params.pipe((0,rxjs__WEBPACK_IMPORTED_MODULE_1__.pluck)('implantCategoryId')));
  ...
  deleteItem(item) {
    if (confirm('Are you sure?')) {
      this.store.deleteImplantCategoryEffect();
    }
  }
  implantAdded($event) {
    console.log('from the overview in Implant Category, added: ', $event);
  }
}
WebImplantCategoryOverviewComponent.ɵfac = function WebImplantCategoryOverviewComponent_Factory(t) {
  return new (t || WebImplantCategoryOverviewComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_case_clinical_web_implant_category_shared__WEBPACK_IMPORTED_MODULE_2__.WebImplantCategoryFeatureStore), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_3__.Router), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_3__.ActivatedRoute));
};
WebImplantCategoryOverviewComponent.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
  type: WebImplantCategoryOverviewComponent,
  selectors: [["ng-component"]],
  features: [_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵProvidersFeature"]([_case_clinical_web_implant_category_shared__WEBPACK_IMPORTED_MODULE_2__.WebImplantCategoryFeatureStore])],
  decls: 2,
  vars: 3,
  consts: [[4, "ngIf"], ["formName", "implantCategory_overview", 3, "showSubmitButton", "componentStore", "model"]],
  template: function WebImplantCategoryOverviewComponent_Template(rf, ctx) {
    if (rf & 1) {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](0, WebImplantCategoryOverviewComponent_ng_container_0_Template, 2, 1, "ng-container", 0);
...
/***/ 764346:
/*!************************************************************************************************************************!*\
  !*** ./libs/web/implant-category/feature/src/lib/web-implant-category-detail/web-implant-category-detail.component.ts ***!
  \************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "WebImplantCategoryDetailComponent": () => (/* binding */ WebImplantCategoryDetailComponent)
/* harmony export */ });
/* harmony import */ var _web_implant_category_detail_store__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./web-implant-category-detail.store */ 223856);
...
const _c0 = ["matDrawer"];
class WebImplantCategoryDetailComponent {
  ...
  ngAfterViewInit() {
    ...
    this.vm$.pipe((0,rxjs__WEBPACK_IMPORTED_MODULE_1__.tap)(s => {
      ...
      if (((_a = s === null || s === void 0 ? void 0 : s.item) === null || _a === void 0 ? void 0 : _a.id) != undefined) {
        this.menuData = [{
          id: 'Details',
          title: 'Implant Category Details',
          type: 'group',
          children: [{
            id: 'details.overview',
            title: 'Overview',
  ...
  deleteItem(item) {
    if (confirm('Are you sure?')) {
      this.store.deleteImplantCategoryEffect(item);
    }
  }
}
WebImplantCategoryDetailComponent.ɵfac = function WebImplantCategoryDetailComponent_Factory(t) {
  return new (t || WebImplantCategoryDetailComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdirectiveInject"](_web_implant_category_detail_store__WEBPACK_IMPORTED_MODULE_4__.WebImplantCategoryDetailStore), _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_5__.ActivatedRoute), _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdirectiveInject"](_angular_core__WEBPACK_IMPORTED_MODULE_3__.ChangeDetectorRef), _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdirectiveInject"](_fuse_services_media_watcher__WEBPACK_IMPORTED_MODULE_6__.FuseMediaWatcherService));
};
WebImplantCategoryDetailComponent.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdefineComponent"]({
  type: WebImplantCategoryDetailComponent,
  selectors: [["ng-component"]],
  viewQuery: function WebImplantCategoryDetailComponent_Query(rf, ctx) {
    if (rf & 1) {
  ...
  features: [_angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵProvidersFeature"]([_web_implant_category_detail_store__WEBPACK_IMPORTED_MODULE_4__.WebImplantCategoryDetailStore])],
  decls: 10,
  vars: 9,
  ...
  template: function WebImplantCategoryDetailComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵlistener"]("click", function WebImplantCategoryDetailComponent_Template_button_click_8_listener() {
...
/***/ 482891:
/*!*********************************************************************************************************************!*\
  !*** ./libs/web/implant-category/feature/src/lib/web-implant-category-detail/web-implant-category-detail.module.ts ***!
  \*********************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "WebImplantCategoryDetailModule": () => (/* binding */ WebImplantCategoryDetailModule)
/* harmony export */ });
...
/* harmony import */ var _web_implant_category_detail_component__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ./web-implant-category-detail.component */ 764346);
/* harmony import */ var _overview_overview_component__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ./overview/overview.component */ 369585);
...
class WebImplantCategoryDetailModule {}
WebImplantCategoryDetailModule.ɵfac = function WebImplantCategoryDetailModule_Factory(t) {
  return new (t || WebImplantCategoryDetailModule)();
};
WebImplantCategoryDetailModule.ɵmod = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineNgModule"]({
  type: WebImplantCategoryDetailModule
});
WebImplantCategoryDetailModule.ɵinj = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
  imports: [_angular_material_button__WEBPACK_IMPORTED_MODULE_1__.MatButtonModule, _angular_material_icon__WEBPACK_IMPORTED_MODULE_2__.MatIconModule, _angular_material_sidenav__WEBPACK_IMPORTED_MODULE_3__.MatSidenavModule, _angular_material_tree__WEBPACK_IMPORTED_MODULE_4__.MatTreeModule, _fuse_components_highlight__WEBPACK_IMPORTED_MODULE_5__.FuseHighlightModule, _fuse_components_alert__WEBPACK_IMPORTED_MODULE_6__.FuseAlertModule, _fuse_components_navigation__WEBPACK_IMPORTED_MODULE_7__.FuseNavigationModule, _fuse_directives_scroll_reset__WEBPACK_IMPORTED_MODULE_8__.FuseScrollResetModule, libs_shared_shared_module__WEBPACK_IMPORTED_MODULE_9__.SharedModule, _angular_common__WEBPACK_IMPORTED_MODULE_10__.CommonModule, _case_clinical_web_ui_panel__WEBPACK_IMPORTED_MODULE_11__.WebUiPanelModule, _case_clinical_web_ui_description_list__WEBPACK_IMPORTED_MODULE_12__.WebUiDescriptionListModule, _case_clinical_web_ui_card_header__WEBPACK_IMPORTED_MODULE_13__.WebUiCardHeaderModule, _case_clinical_web_ui_page__WEBPACK_IMPORTED_MODULE_14__.WebUiPageModule, _case_clinical_web_shared_ui__WEBPACK_IMPORTED_MODULE_15__.UtilitySharedModule, _case_clinical_web_shared_ui__WEBPACK_IMPORTED_MODULE_16__.UiFormsSharedModule, _case_clinical_web_core_feature__WEBPACK_IMPORTED_MODULE_17__.WebCoreFeatureModule, _case_clinical_web_ui_formly_designer__WEBPACK_IMPORTED_MODULE_18__.WebUiFormlyDesignerModule, _angular_router__WEBPACK_IMPORTED_MODULE_19__.RouterModule.forChild([{
    path: '',
    component: _web_implant_category_detail_component__WEBPACK_IMPORTED_MODULE_20__.WebImplantCategoryDetailComponent,
    children: [{
      path: 'overview',
      pathMatch: 'full',
      component: _overview_overview_component__WEBPACK_IMPORTED_MODULE_21__.WebImplantCategoryOverviewComponent
    }, {
      path: 'edit',
      loadChildren: () => __webpack_require__.e(/*! import() */ "libs_web_implant-category_feature_src_lib_web-implant-category-edit_web-implant-category-edit-0a57bd").then(__webpack_require__.bind(__webpack_require__, /*! ../web-implant-category-edit/web-implant-category-edit.module */ 405748)).then(m => m.WebImplantCategoryEditModule)
    }, {
      path: 'implants',
...
(function () {
  (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](WebImplantCategoryDetailModule, {
    declarations: [_web_implant_category_detail_component__WEBPACK_IMPORTED_MODULE_20__.WebImplantCategoryDetailComponent, _overview_overview_component__WEBPACK_IMPORTED_MODULE_21__.WebImplantCategoryOverviewComponent],
...
/***/ 223856:
/*!********************************************************************************************************************!*\
  !*** ./libs/web/implant-category/feature/src/lib/web-implant-category-detail/web-implant-category-detail.store.ts ***!
  \********************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "WebImplantCategoryDetailStore": () => (/* binding */ WebImplantCategoryDetailStore)
/* harmony export */ });
...
class WebImplantCategoryDetailStore extends _ngrx_component_store__WEBPACK_IMPORTED_MODULE_0__.ComponentStore {
  constructor(data, router, route, toast) {
    ...
    this.loadImplantCategoryEffect = this.effect(implantCategoryId$ => implantCategoryId$.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_1__.tap)(() => this.setState({
      loading: true
    ...
    this.deleteImplantCategoryEffect = this.effect(implantCategory$ => implantCategory$.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.switchMap)(implantCategory => this.data.userDeleteImplantCategory({
      implantCategoryId: implantCategory.id
    }).pipe((0,_ngrx_component_store__WEBPACK_IMPORTED_MODULE_0__.tapResponse)(res => {
      this.toast.success("Deleted successfully!", {
        duration: 3000
      });
      return this.router.navigate(['/queues/implant-categories']);
    }, errors => this.patchState({
      loading: false,
      errors: errors.graphQLErrors ? errors.graphQLErrors : errors
    }))))));
    this.loadImplantCategoryEffect(route.params.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.pluck)('implantCategoryId')));
  }
}
WebImplantCategoryDetailStore.ɵfac = function WebImplantCategoryDetailStore_Factory(t) {
  return new (t || WebImplantCategoryDetailStore)(_angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵinject"](_case_clinical_web_core_data_access__WEBPACK_IMPORTED_MODULE_5__.WebCoreDataAccessService), _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵinject"](_angular_router__WEBPACK_IMPORTED_MODULE_6__.Router), _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵinject"](_angular_router__WEBPACK_IMPORTED_MODULE_6__.ActivatedRoute), _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵinject"](_case_clinical_web_ui_toast__WEBPACK_IMPORTED_MODULE_7__.WebUiToastService));
};
WebImplantCategoryDetailStore.ɵprov = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵdefineInjectable"]({
  token: WebImplantCategoryDetailStore,
  factory: WebImplantCategoryDetailStore.ɵfac
});
