"use strict";
(self["webpackChunkweb"] = self["webpackChunkweb"] || []).push([["libs_web_team-user_feature_src_lib_web-team-user-detail_web-team-user-detail_module_ts"],{

/***/ 989469:
/*!************************************************************************************************!*\
  !*** ./libs/web/team-user/feature/src/lib/web-team-user-detail/overview/overview.component.ts ***!
  \************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "WebTeamUserOverviewComponent": () => (/* binding */ WebTeamUserOverviewComponent)
/* harmony export */ });
/* harmony import */ var _case_clinical_web_team_user_shared__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @case-clinical/web/team-user/shared */ 693340);
...
function WebTeamUserOverviewComponent_ng_container_0_ng_container_1_Template(rf, ctx) {
  if (rf & 1) {
...
function WebTeamUserOverviewComponent_ng_container_0_Template(rf, ctx) {
  if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementContainerStart"](0);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](1, WebTeamUserOverviewComponent_ng_container_0_ng_container_1_Template, 2, 3, "ng-container", 0);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementContainerEnd"]();
  }
  if (rf & 2) {
...
class WebTeamUserOverviewComponent {
  ...
  ngOnInit() {
    this.store.loadTeamUserEffect(this.route.params.pipe((0,rxjs__WEBPACK_IMPORTED_MODULE_1__.pluck)('teamUserId')));
  ...
  deleteItem(item) {
    if (confirm('Are you sure?')) {
      this.store.deleteTeamUserEffect();
    }
  }
}
WebTeamUserOverviewComponent.ɵfac = function WebTeamUserOverviewComponent_Factory(t) {
  return new (t || WebTeamUserOverviewComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_case_clinical_web_team_user_shared__WEBPACK_IMPORTED_MODULE_2__.WebTeamUserFeatureStore), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_3__.Router), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_3__.ActivatedRoute));
};
WebTeamUserOverviewComponent.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
  type: WebTeamUserOverviewComponent,
  selectors: [["ng-component"]],
  features: [_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵProvidersFeature"]([_case_clinical_web_team_user_shared__WEBPACK_IMPORTED_MODULE_2__.WebTeamUserFeatureStore])],
  decls: 2,
  vars: 3,
  consts: [[4, "ngIf"], ["formName", "teamUser_overview", 3, "showSubmitButton", "componentStore", "model"]],
  template: function WebTeamUserOverviewComponent_Template(rf, ctx) {
    if (rf & 1) {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](0, WebTeamUserOverviewComponent_ng_container_0_Template, 2, 1, "ng-container", 0);
...
/***/ 214876:
/*!***************************************************************************************************!*\
  !*** ./libs/web/team-user/feature/src/lib/web-team-user-detail/web-team-user-detail.component.ts ***!
  \***************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "WebTeamUserDetailComponent": () => (/* binding */ WebTeamUserDetailComponent)
/* harmony export */ });
/* harmony import */ var _web_team_user_detail_store__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./web-team-user-detail.store */ 126627);
...
const _c0 = ["matDrawer"];
class WebTeamUserDetailComponent {
  ...
  deleteItem(item) {
    if (confirm('Are you sure?')) {
      this.store.deleteTeamUserEffect(item);
    }
  }
}
WebTeamUserDetailComponent.ɵfac = function WebTeamUserDetailComponent_Factory(t) {
  return new (t || WebTeamUserDetailComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdirectiveInject"](_web_team_user_detail_store__WEBPACK_IMPORTED_MODULE_4__.WebTeamUserDetailStore), _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_5__.ActivatedRoute), _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdirectiveInject"](_angular_core__WEBPACK_IMPORTED_MODULE_3__.ChangeDetectorRef), _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdirectiveInject"](_fuse_services_media_watcher__WEBPACK_IMPORTED_MODULE_6__.FuseMediaWatcherService));
};
WebTeamUserDetailComponent.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdefineComponent"]({
  type: WebTeamUserDetailComponent,
  selectors: [["ng-component"]],
  viewQuery: function WebTeamUserDetailComponent_Query(rf, ctx) {
    if (rf & 1) {
  ...
  features: [_angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵProvidersFeature"]([_web_team_user_detail_store__WEBPACK_IMPORTED_MODULE_4__.WebTeamUserDetailStore])],
  decls: 10,
  vars: 9,
  ...
  template: function WebTeamUserDetailComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵlistener"]("click", function WebTeamUserDetailComponent_Template_button_click_8_listener() {
...
/***/ 877572:
/*!************************************************************************************************!*\
  !*** ./libs/web/team-user/feature/src/lib/web-team-user-detail/web-team-user-detail.module.ts ***!
  \************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "WebTeamUserDetailModule": () => (/* binding */ WebTeamUserDetailModule)
/* harmony export */ });
...
/* harmony import */ var _web_team_user_detail_component__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ./web-team-user-detail.component */ 214876);
/* harmony import */ var _overview_overview_component__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ./overview/overview.component */ 989469);
...
class WebTeamUserDetailModule {}
WebTeamUserDetailModule.ɵfac = function WebTeamUserDetailModule_Factory(t) {
  return new (t || WebTeamUserDetailModule)();
};
WebTeamUserDetailModule.ɵmod = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineNgModule"]({
  type: WebTeamUserDetailModule
});
WebTeamUserDetailModule.ɵinj = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
  imports: [_angular_material_button__WEBPACK_IMPORTED_MODULE_1__.MatButtonModule, _angular_material_icon__WEBPACK_IMPORTED_MODULE_2__.MatIconModule, _angular_material_sidenav__WEBPACK_IMPORTED_MODULE_3__.MatSidenavModule, _angular_material_tree__WEBPACK_IMPORTED_MODULE_4__.MatTreeModule, _fuse_components_highlight__WEBPACK_IMPORTED_MODULE_5__.FuseHighlightModule, _fuse_components_alert__WEBPACK_IMPORTED_MODULE_6__.FuseAlertModule, _fuse_components_navigation__WEBPACK_IMPORTED_MODULE_7__.FuseNavigationModule, _fuse_directives_scroll_reset__WEBPACK_IMPORTED_MODULE_8__.FuseScrollResetModule, libs_shared_shared_module__WEBPACK_IMPORTED_MODULE_9__.SharedModule, _angular_common__WEBPACK_IMPORTED_MODULE_10__.CommonModule, _case_clinical_web_ui_panel__WEBPACK_IMPORTED_MODULE_11__.WebUiPanelModule, _case_clinical_web_ui_description_list__WEBPACK_IMPORTED_MODULE_12__.WebUiDescriptionListModule, _case_clinical_web_ui_card_header__WEBPACK_IMPORTED_MODULE_13__.WebUiCardHeaderModule, _case_clinical_web_ui_page__WEBPACK_IMPORTED_MODULE_14__.WebUiPageModule, _case_clinical_web_shared_ui__WEBPACK_IMPORTED_MODULE_15__.UtilitySharedModule, _case_clinical_web_shared_ui__WEBPACK_IMPORTED_MODULE_16__.UiFormsSharedModule, _case_clinical_web_core_feature__WEBPACK_IMPORTED_MODULE_17__.WebCoreFeatureModule, _case_clinical_web_ui_formly_designer__WEBPACK_IMPORTED_MODULE_18__.WebUiFormlyDesignerModule, _angular_router__WEBPACK_IMPORTED_MODULE_19__.RouterModule.forChild([{
    path: '',
    component: _web_team_user_detail_component__WEBPACK_IMPORTED_MODULE_20__.WebTeamUserDetailComponent,
    children: [{
      path: 'overview',
      pathMatch: 'full',
      component: _overview_overview_component__WEBPACK_IMPORTED_MODULE_21__.WebTeamUserOverviewComponent
    }, {
      path: 'edit',
      loadChildren: () => __webpack_require__.e(/*! import() */ "libs_web_team-user_feature_src_lib_web-team-user-edit_web-team-user-edit_module_ts").then(__webpack_require__.bind(__webpack_require__, /*! ../web-team-user-edit/web-team-user-edit.module */ 219512)).then(m => m.WebTeamUserEditModule)
    }, {
      path: '',
      pathMatch: 'full',
      redirectTo: 'overview'
...
(function () {
  (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](WebTeamUserDetailModule, {
    declarations: [_web_team_user_detail_component__WEBPACK_IMPORTED_MODULE_20__.WebTeamUserDetailComponent, _overview_overview_component__WEBPACK_IMPORTED_MODULE_21__.WebTeamUserOverviewComponent],
...
/***/ 126627:
/*!***********************************************************************************************!*\
  !*** ./libs/web/team-user/feature/src/lib/web-team-user-detail/web-team-user-detail.store.ts ***!
  \***********************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "WebTeamUserDetailStore": () => (/* binding */ WebTeamUserDetailStore)
/* harmony export */ });
...
class WebTeamUserDetailStore extends _ngrx_component_store__WEBPACK_IMPORTED_MODULE_0__.ComponentStore {
  constructor(data, router, route, toast) {
    ...
    this.loadTeamUserEffect = this.effect(teamUserId$ => teamUserId$.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_1__.tap)(() => this.setState({
      loading: true
    })), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.switchMap)(teamUserId => this.data.userTeamUser({
      teamUserId
    ...
    this.deleteTeamUserEffect = this.effect(teamUser$ => teamUser$.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.switchMap)(teamUser => this.data.userDeleteTeamUser({
      teamUserId: teamUser.id
    }).pipe((0,_ngrx_component_store__WEBPACK_IMPORTED_MODULE_0__.tapResponse)(res => {
      this.toast.success("Deleted successfully!", {
        duration: 3000
      });
      return this.router.navigate(['/queues/team-users']);
    }, errors => this.patchState({
      loading: false,
      errors: errors.graphQLErrors ? errors.graphQLErrors : errors
    }))))));
    this.loadTeamUserEffect(route.params.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.pluck)('teamUserId')));
  }
}
WebTeamUserDetailStore.ɵfac = function WebTeamUserDetailStore_Factory(t) {
  return new (t || WebTeamUserDetailStore)(_angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵinject"](_case_clinical_web_core_data_access__WEBPACK_IMPORTED_MODULE_5__.WebCoreDataAccessService), _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵinject"](_angular_router__WEBPACK_IMPORTED_MODULE_6__.Router), _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵinject"](_angular_router__WEBPACK_IMPORTED_MODULE_6__.ActivatedRoute), _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵinject"](_case_clinical_web_ui_toast__WEBPACK_IMPORTED_MODULE_7__.WebUiToastService));
};
WebTeamUserDetailStore.ɵprov = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵdefineInjectable"]({
  token: WebTeamUserDetailStore,
  factory: WebTeamUserDetailStore.ɵfac
});
