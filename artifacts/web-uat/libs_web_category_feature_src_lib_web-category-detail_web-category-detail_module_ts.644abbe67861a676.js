"use strict";
(self["webpackChunkweb"] = self["webpackChunkweb"] || []).push([["libs_web_category_feature_src_lib_web-category-detail_web-category-detail_module_ts"],{

/***/ 376972:
/*!**********************************************************************************************!*\
  !*** ./libs/web/category/feature/src/lib/web-category-detail/overview/overview.component.ts ***!
  \**********************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "WebCategoryOverviewComponent": () => (/* binding */ WebCategoryOverviewComponent)
/* harmony export */ });
/* harmony import */ var _case_clinical_web_category_shared__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @case-clinical/web/category/shared */ 669145);
...
function WebCategoryOverviewComponent_ng_container_0_ng_container_1_Template(rf, ctx) {
  if (rf & 1) {
...
function WebCategoryOverviewComponent_ng_container_0_Template(rf, ctx) {
  if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementContainerStart"](0);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](1, WebCategoryOverviewComponent_ng_container_0_ng_container_1_Template, 2, 3, "ng-container", 0);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementContainerEnd"]();
  }
  if (rf & 2) {
...
class WebCategoryOverviewComponent {
  ...
  ngOnInit() {
    this.store.loadCategoryEffect(this.route.params.pipe((0,rxjs__WEBPACK_IMPORTED_MODULE_1__.pluck)('categoryId')));
  ...
  deleteItem(item) {
    if (confirm('Are you sure?')) {
      this.store.deleteCategoryEffect();
    }
  }
  authorizationKindAdded($event) {
    console.log('from the overview in Category, added: ', $event);
  }
}
WebCategoryOverviewComponent.ɵfac = function WebCategoryOverviewComponent_Factory(t) {
  return new (t || WebCategoryOverviewComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_case_clinical_web_category_shared__WEBPACK_IMPORTED_MODULE_2__.WebCategoryFeatureStore), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_3__.Router), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_3__.ActivatedRoute));
};
WebCategoryOverviewComponent.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
  type: WebCategoryOverviewComponent,
  selectors: [["ng-component"]],
  features: [_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵProvidersFeature"]([_case_clinical_web_category_shared__WEBPACK_IMPORTED_MODULE_2__.WebCategoryFeatureStore])],
  decls: 2,
  vars: 3,
  consts: [[4, "ngIf"], ["formName", "category_overview", 3, "showSubmitButton", "componentStore", "model"]],
  template: function WebCategoryOverviewComponent_Template(rf, ctx) {
    if (rf & 1) {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](0, WebCategoryOverviewComponent_ng_container_0_Template, 2, 1, "ng-container", 0);
...
/***/ 732651:
/*!************************************************************************************************!*\
  !*** ./libs/web/category/feature/src/lib/web-category-detail/web-category-detail.component.ts ***!
  \************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "WebCategoryDetailComponent": () => (/* binding */ WebCategoryDetailComponent)
/* harmony export */ });
/* harmony import */ var _web_category_detail_store__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./web-category-detail.store */ 8729);
...
const _c0 = ["matDrawer"];
class WebCategoryDetailComponent {
      ...
      if (((_a = s === null || s === void 0 ? void 0 : s.item) === null || _a === void 0 ? void 0 : _a.id) != undefined) {
        this.menuData = [{
          ...
          children: [{
            ...
            id: 'details.authorizationKind',
            title: 'Authorization Kinds',
            type: 'basic',
            link: `${routeString}/authorization-kinds`
          }]
        }];
      }
    })).subscribe();
  ...
  deleteItem(item) {
    if (confirm('Are you sure?')) {
      this.store.deleteCategoryEffect(item);
    }
  }
}
WebCategoryDetailComponent.ɵfac = function WebCategoryDetailComponent_Factory(t) {
  return new (t || WebCategoryDetailComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdirectiveInject"](_web_category_detail_store__WEBPACK_IMPORTED_MODULE_4__.WebCategoryDetailStore), _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_5__.ActivatedRoute), _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdirectiveInject"](_angular_core__WEBPACK_IMPORTED_MODULE_3__.ChangeDetectorRef), _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdirectiveInject"](_fuse_services_media_watcher__WEBPACK_IMPORTED_MODULE_6__.FuseMediaWatcherService));
};
WebCategoryDetailComponent.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdefineComponent"]({
  type: WebCategoryDetailComponent,
  selectors: [["ng-component"]],
  viewQuery: function WebCategoryDetailComponent_Query(rf, ctx) {
    if (rf & 1) {
  ...
  features: [_angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵProvidersFeature"]([_web_category_detail_store__WEBPACK_IMPORTED_MODULE_4__.WebCategoryDetailStore])],
  decls: 10,
  vars: 9,
  ...
  template: function WebCategoryDetailComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵlistener"]("click", function WebCategoryDetailComponent_Template_button_click_8_listener() {
...
/***/ 962147:
/*!*********************************************************************************************!*\
  !*** ./libs/web/category/feature/src/lib/web-category-detail/web-category-detail.module.ts ***!
  \*********************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "WebCategoryDetailModule": () => (/* binding */ WebCategoryDetailModule)
/* harmony export */ });
...
/* harmony import */ var _web_category_detail_component__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ./web-category-detail.component */ 732651);
/* harmony import */ var _overview_overview_component__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ./overview/overview.component */ 376972);
...
class WebCategoryDetailModule {}
WebCategoryDetailModule.ɵfac = function WebCategoryDetailModule_Factory(t) {
  return new (t || WebCategoryDetailModule)();
};
WebCategoryDetailModule.ɵmod = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineNgModule"]({
  type: WebCategoryDetailModule
});
WebCategoryDetailModule.ɵinj = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
  imports: [_angular_material_button__WEBPACK_IMPORTED_MODULE_1__.MatButtonModule, _angular_material_icon__WEBPACK_IMPORTED_MODULE_2__.MatIconModule, _angular_material_sidenav__WEBPACK_IMPORTED_MODULE_3__.MatSidenavModule, _angular_material_tree__WEBPACK_IMPORTED_MODULE_4__.MatTreeModule, _fuse_components_highlight__WEBPACK_IMPORTED_MODULE_5__.FuseHighlightModule, _fuse_components_alert__WEBPACK_IMPORTED_MODULE_6__.FuseAlertModule, _fuse_components_navigation__WEBPACK_IMPORTED_MODULE_7__.FuseNavigationModule, _fuse_directives_scroll_reset__WEBPACK_IMPORTED_MODULE_8__.FuseScrollResetModule, libs_shared_shared_module__WEBPACK_IMPORTED_MODULE_9__.SharedModule, _angular_common__WEBPACK_IMPORTED_MODULE_10__.CommonModule, _case_clinical_web_ui_panel__WEBPACK_IMPORTED_MODULE_11__.WebUiPanelModule, _case_clinical_web_ui_description_list__WEBPACK_IMPORTED_MODULE_12__.WebUiDescriptionListModule, _case_clinical_web_ui_card_header__WEBPACK_IMPORTED_MODULE_13__.WebUiCardHeaderModule, _case_clinical_web_ui_page__WEBPACK_IMPORTED_MODULE_14__.WebUiPageModule, _case_clinical_web_shared_ui__WEBPACK_IMPORTED_MODULE_15__.UtilitySharedModule, _case_clinical_web_shared_ui__WEBPACK_IMPORTED_MODULE_16__.UiFormsSharedModule, _case_clinical_web_core_feature__WEBPACK_IMPORTED_MODULE_17__.WebCoreFeatureModule, _case_clinical_web_ui_formly_designer__WEBPACK_IMPORTED_MODULE_18__.WebUiFormlyDesignerModule, _angular_router__WEBPACK_IMPORTED_MODULE_19__.RouterModule.forChild([{
    path: '',
    component: _web_category_detail_component__WEBPACK_IMPORTED_MODULE_20__.WebCategoryDetailComponent,
    children: [{
      path: 'overview',
      pathMatch: 'full',
      component: _overview_overview_component__WEBPACK_IMPORTED_MODULE_21__.WebCategoryOverviewComponent
    }, {
      path: 'edit',
      loadChildren: () => __webpack_require__.e(/*! import() */ "libs_web_category_feature_src_lib_web-category-edit_web-category-edit_module_ts").then(__webpack_require__.bind(__webpack_require__, /*! ../web-category-edit/web-category-edit.module */ 476055)).then(m => m.WebCategoryEditModule)
    }, {
      path: 'authorization-kinds',
      loadChildren: () => __webpack_require__.e(/*! import() */ "common").then(__webpack_require__.bind(__webpack_require__, /*! @case-clinical/web/authorization-kind/feature */ 842211)).then(m => m.WebAuthorizationKindFeatureModule)
    }, {
      path: '',
      pathMatch: 'full',
      redirectTo: 'overview'
...
(function () {
  (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](WebCategoryDetailModule, {
    declarations: [_web_category_detail_component__WEBPACK_IMPORTED_MODULE_20__.WebCategoryDetailComponent, _overview_overview_component__WEBPACK_IMPORTED_MODULE_21__.WebCategoryOverviewComponent],
...
/***/ 8729:
/*!********************************************************************************************!*\
  !*** ./libs/web/category/feature/src/lib/web-category-detail/web-category-detail.store.ts ***!
  \********************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "WebCategoryDetailStore": () => (/* binding */ WebCategoryDetailStore)
/* harmony export */ });
...
class WebCategoryDetailStore extends _ngrx_component_store__WEBPACK_IMPORTED_MODULE_0__.ComponentStore {
  constructor(data, router, route, toast) {
    ...
    this.displayItems$ = this.select(this.item$, item => [{
      ...
      label: 'Authorization Kinds',
      value: item === null || item === void 0 ? void 0 : item.authorizationKinds
    }]);
    ...
    this.loadCategoryEffect = this.effect(categoryId$ => categoryId$.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_1__.tap)(() => this.setState({
      loading: true
    ...
    this.deleteCategoryEffect = this.effect(category$ => category$.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.switchMap)(category => this.data.userDeleteCategory({
      categoryId: category.id
    }).pipe((0,_ngrx_component_store__WEBPACK_IMPORTED_MODULE_0__.tapResponse)(res => {
      this.toast.success("Deleted successfully!", {
        duration: 3000
      });
      return this.router.navigate(['/queues/categories']);
    }, errors => this.patchState({
      loading: false,
      errors: errors.graphQLErrors ? errors.graphQLErrors : errors
    }))))));
    this.loadCategoryEffect(route.params.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.pluck)('categoryId')));
  }
}
WebCategoryDetailStore.ɵfac = function WebCategoryDetailStore_Factory(t) {
  return new (t || WebCategoryDetailStore)(_angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵinject"](_case_clinical_web_core_data_access__WEBPACK_IMPORTED_MODULE_5__.WebCoreDataAccessService), _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵinject"](_angular_router__WEBPACK_IMPORTED_MODULE_6__.Router), _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵinject"](_angular_router__WEBPACK_IMPORTED_MODULE_6__.ActivatedRoute), _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵinject"](_case_clinical_web_ui_toast__WEBPACK_IMPORTED_MODULE_7__.WebUiToastService));
};
WebCategoryDetailStore.ɵprov = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵdefineInjectable"]({
  token: WebCategoryDetailStore,
  factory: WebCategoryDetailStore.ɵfac
});
