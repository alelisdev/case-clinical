...
test('legal-case-create-button-test', async ({ page }) => {
  ...
  //const elementCount = await page.getByText(`${PAGETITLE} Create`).count();
  await expect(await page.getByText(`${PAGETITLE} Create`)).toBeVisible()
});