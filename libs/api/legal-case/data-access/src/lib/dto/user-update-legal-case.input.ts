...
import { UserUpdateCaseStatusInput } from '@case-clinical/api/case-status/data-access' 
import { UserUpdateCaseTypeInput } from '@case-clinical/api/case-type/data-access' 
import { UserUpdatePatientTreatmentStatusInput } from '@case-clinical/api/patient-treatment-status/data-access' 
import { UserUpdateCaseProgressStatusInput } from '@case-clinical/api/case-progress-status/data-access' 
import { UserUpdateAdverseInsuranceStatusInput } from '@case-clinical/api/adverse-insurance-status/data-access' 
...
@InputType()
export class UserUpdateLegalCaseInput {
  ...
  propertyDamages?: UserUpdateDocumentInput[]


  @Field(() => [UserUpdateDocumentInput], { nullable: true }) 
  miscellaneousDocuments?: UserUpdateDocumentInput[]
