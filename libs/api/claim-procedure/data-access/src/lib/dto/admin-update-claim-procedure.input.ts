...
import { AdminUpdatePlaceOfServiceInput } from '@case-clinical/api/place-of-service/data-access' 
import { AdminUpdateClaimStatusInput } from '@case-clinical/api/claim-status/data-access' 
import { AdminUpdateClaimInput } from '@case-clinical/api/claim/data-access' 
...
@InputType()
export class AdminUpdateClaimProcedureInput {
  ...
  @Field(() => AdminUpdatePlaceOfServiceInput ,{ nullable: true }) 
  placeOfService?: AdminUpdatePlaceOfServiceInput  


  @Field(() => AdminUpdateClaimStatusInput ,{ nullable: true }) 
  claimStatus?: AdminUpdateClaimStatusInput  


  @Field(() => AdminUpdateClaimInput ,{ nullable: true }) 
  claim?: AdminUpdateClaimInput  
