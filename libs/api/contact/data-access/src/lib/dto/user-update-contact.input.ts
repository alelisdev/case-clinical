...
import { UserUpdateContactKindInput } from '@case-clinical/api/contact-kind/data-access' 
...
@InputType()
export class UserUpdateContactInput {
  ...
  contactKind?: UserUpdateContactKindInput  
