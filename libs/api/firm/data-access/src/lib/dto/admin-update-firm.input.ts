...
import { AdminUpdateFirmStatusInput } from '@case-clinical/api/firm-status/data-access' 
...
@InputType()
export class AdminUpdateFirmInput {
  ...
  @Field(() => AdminUpdateFirmStatusInput ,{ nullable: true }) 
  firmStatus?: AdminUpdateFirmStatusInput  


  @Field(() => AdminUpdateDocumentInput ,{ nullable: true }) 
  eula?: AdminUpdateDocumentInput  
