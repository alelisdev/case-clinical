...
import { UserUpdateEthnicityInput } from '@case-clinical/api/ethnicity/data-access' 
import { UserUpdateGenderInput } from '@case-clinical/api/gender/data-access' 
import { UserUpdateLanguageInput } from '@case-clinical/api/language/data-access' 
...
@InputType()
export class UserUpdatePatientInput {
  ...
  ethnicity?: UserUpdateEthnicityInput  
  ...
  language?: UserUpdateLanguageInput  

  @Field(() => UserUpdateDocumentInput ,{ nullable: true })
  subpoena?: UserUpdateDocumentInput
}