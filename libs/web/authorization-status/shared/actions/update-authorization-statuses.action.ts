...
import {UserUpdateAuthorizationStatusInput, UpdateResult} from '@case-clinical/shared/util/sdk';

export class UpdateAuthorizationStatusesAction extends AuthorizationStatusBusinessActionBase<UpdateResult> {
