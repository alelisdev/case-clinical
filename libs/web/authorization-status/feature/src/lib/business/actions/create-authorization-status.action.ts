...
export class CreateAuthorizationStatusAction extends AuthorizationStatusBusinessActionBase<AuthorizationStatus> {constructor(private input: UserCreateAuthorizationStatusInput) {
