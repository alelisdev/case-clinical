...
import { ClinicalProvider, Location } from '@case-clinical/shared/util/sdk'
export class ValidateClinicalProviderLocationExcelDataAction extends ClinicalProviderLocationBusinessActionBase<boolean> {
...
locations: Location[]
  ...
  constructor(excelData: any[], clinicalProviders: ClinicalProvider[], locations: Location[]) {
