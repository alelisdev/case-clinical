...
import { currencyFormatter, dateFormatter, ClinicalProviderLocation } from '@case-clinical/web/core/data-access'
import { TableViewComponent } from '@case-clinical/web/datatable/ui'

@Component({
  selector: 'ui-clinical-provider-location-select-table-view',
  template: `
    <table-view
      ...
      [data]="clinicalProviderLocations"
...
export class WebClinicalProviderLocationSelectTableViewComponent {
