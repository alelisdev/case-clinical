...
import {UserUpdateClaimProcedureInput, UpdateResult} from '@case-clinical/shared/util/sdk';

export class UpdateClaimProceduresAction extends ClaimProcedureBusinessActionBase<UpdateResult> {
