...
export class CreateClaimProcedureAction extends ClaimProcedureBusinessActionBase<ClaimProcedure> {
  constructor(private input: UserCreateClaimProcedureInput) {
