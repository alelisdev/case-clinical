...
import { WebNavigationListComponent } from './web-navigation-list.component'
...
@NgModule({
  declarations: [WebNavigationListComponent],
  imports: [
    ...
    RouterModule.forChild([{ path: '', component: WebNavigationListComponent }]),

  ],
})
export class WebNavigationListModule {}
