...
import {UserUpdateAccidentTypeInput} from '@case-clinical/shared/util/sdk';

export class UpdateAccidentTypesAction extends AccidentTypeBusinessActionBase<boolean> {
