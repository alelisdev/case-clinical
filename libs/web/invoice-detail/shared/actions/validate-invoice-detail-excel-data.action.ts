...
import { Invoice } from '@case-clinical/shared/util/sdk'
export class ValidateInvoiceDetailExcelDataAction extends InvoiceDetailBusinessActionBase<boolean> {
  ...
  constructor(excelData: any[], invoices: Invoice[]) {
    super('ValidateInvoiceDetailExcelDataAction')
