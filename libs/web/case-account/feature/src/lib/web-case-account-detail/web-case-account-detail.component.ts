...
import { WebCaseAccountDetailStore } from './web-case-account-detail.store'
import {
...
@Component({
  templateUrl: `./web-case-account-detail.component.html`,
  providers: [WebCaseAccountDetailStore],
  encapsulation: ViewEncapsulation.None,
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class WebCaseAccountDetailComponent implements AfterViewInit {
  @ViewChild('matDrawer', { static: true }) matDrawer: MatDrawer
  drawerMode: 'side' | 'over'
  drawerOpened: boolean
  menuData: FuseNavigationItem[] = []
  private _unsubscribeAll: Subject<any> = new Subject<any>()
  private _item: CaseAccount
  readonly vm$ = this.store.vm$

  constructor(
    private readonly store: WebCaseAccountDetailStore,
