...
import {UserUpdateCaseAccountInput, UpdateResult} from '@case-clinical/shared/util/sdk';

export class UpdateCaseAccountsAction extends CaseAccountBusinessActionBase<UpdateResult> {
