...
import {UserUpdateClaimStatusInput} from '@case-clinical/shared/util/sdk';

export class UpdateClaimStatusesAction extends ClaimStatusBusinessActionBase<boolean> {
