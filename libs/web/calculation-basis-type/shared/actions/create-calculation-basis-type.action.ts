...
export class CreateCalculationBasisTypeAction extends CalculationBasisTypeBusinessActionBase<CalculationBasisType> {
  constructor(private input: UserCreateCalculationBasisTypeInput) {
