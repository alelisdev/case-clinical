...
@Component({
  templateUrl: `./calculation-basis-type-select.component.html`,
})
export class CalculationBasisTypeSelectComponent extends FieldType implements OnInit {
