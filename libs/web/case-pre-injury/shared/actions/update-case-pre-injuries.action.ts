...
import {UserUpdateCasePreInjuryInput, UpdateResult} from '@case-clinical/shared/util/sdk';

export class UpdateCasePreInjuriesAction extends CasePreInjuryBusinessActionBase<UpdateResult> {
