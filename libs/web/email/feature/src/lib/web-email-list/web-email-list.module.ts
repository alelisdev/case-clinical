...
import { WebEmailListComponent } from './web-email-list.component'
...
@NgModule({
  declarations: [WebEmailListComponent],
  imports: [
    ...
    RouterModule.forChild([{ path: '', component: WebEmailListComponent }]),

  ],
})
export class WebEmailListModule {}
