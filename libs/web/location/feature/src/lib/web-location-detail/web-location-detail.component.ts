...
import { WebLocationDetailStore } from './web-location-detail.store'
import {
...
@Component({
  templateUrl: `./web-location-detail.component.html`,
  providers: [WebLocationDetailStore],
  encapsulation: ViewEncapsulation.None,
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class WebLocationDetailComponent implements AfterViewInit {
  @ViewChild('matDrawer', { static: true }) matDrawer: MatDrawer
  drawerMode: 'side' | 'over'
  drawerOpened: boolean
  menuData: FuseNavigationItem[] = []
  private _unsubscribeAll: Subject<any> = new Subject<any>()
  private _item: Location
  readonly vm$ = this.store.vm$

  constructor(
    private readonly store: WebLocationDetailStore,
