...
import {UserUpdatePrescriptionInput, UpdateResult} from '@case-clinical/shared/util/sdk';

export class UpdatePrescriptionsAction extends PrescriptionBusinessActionBase<UpdateResult> {
