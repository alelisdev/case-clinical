...
import { WebShortcutListComponent } from './web-shortcut-list.component'
...
@NgModule({
  declarations: [WebShortcutListComponent],
  imports: [
    ...
    RouterModule.forChild([{ path: '', component: WebShortcutListComponent }]),

  ],
})
export class WebShortcutListModule {}
