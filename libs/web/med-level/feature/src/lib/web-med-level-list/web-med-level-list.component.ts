...
import { WebMedLevelSelectTableViewComponent } from '@case-clinical/web/med-level/ui';
...
@Component({
  template: `
    <ng-container *featureFlag="'MedLevel.View'">
...
export class WebMedLevelListComponent implements OnInit {
  @ViewChild(WebMedLevelSelectTableViewComponent) tableView: WebMedLevelSelectTableViewComponent
