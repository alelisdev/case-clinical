...
import {UserUpdatePriorAuthDmeInput, UpdateResult} from '@case-clinical/shared/util/sdk';

export class UpdatePriorAuthDmesAction extends PriorAuthDmeBusinessActionBase<UpdateResult> {
