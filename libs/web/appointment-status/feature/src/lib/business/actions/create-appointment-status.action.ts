...
export class CreateAppointmentStatusAction extends AppointmentStatusBusinessActionBase<AppointmentStatus> {constructor(private input: UserCreateAppointmentStatusInput) {
