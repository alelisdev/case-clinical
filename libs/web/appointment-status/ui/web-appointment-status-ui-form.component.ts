...
import { WebAppointmentStatusFormStore } from './web-appointment-status-form.store'
...
@Component({
  ...
  providers: [WebAppointmentStatusFormStore],
  template: `
...
className: 'sm:w-full md:w-1/2 lg:w-1/4  px-1'
  ...
  constructor(
    private readonly store: WebAppointmentStatusFormStore,
  ...
  async submit({ name }) {
    ...
    await this.store.createAppointmentStatusEffect({ name })
