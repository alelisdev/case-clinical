...
export class CreatePriorAuthorizationProcedureCodeAction extends PriorAuthorizationProcedureCodeBusinessActionBase<PriorAuthorizationProcedureCode> {constructor(private input: UserCreatePriorAuthorizationProcedureCodeInput) {
