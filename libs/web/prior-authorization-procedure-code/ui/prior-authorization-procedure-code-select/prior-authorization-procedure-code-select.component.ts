...
@Component({
  templateUrl: `./prior-authorization-procedure-code-select.component.html`,
})
export class PriorAuthorizationProcedureCodeSelectComponent extends FieldType implements OnInit {
  ...
  openDialog<T>(
    ...
    }: { priorAuthorizationProcedureCode ?: T },
  ) {
