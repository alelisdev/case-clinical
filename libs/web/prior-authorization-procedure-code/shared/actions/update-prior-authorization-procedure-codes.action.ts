...
import {UserUpdatePriorAuthorizationProcedureCodeInput, UpdateResult} from '@case-clinical/shared/util/sdk';

export class UpdatePriorAuthorizationProcedureCodesAction extends PriorAuthorizationProcedureCodeBusinessActionBase<UpdateResult> {
