...
import {UserUpdateContractKindInput, UpdateResult} from '@case-clinical/shared/util/sdk';

export class UpdateContractKindsAction extends ContractKindBusinessActionBase<UpdateResult> {
