...
import { currencyFormatter, dateFormatter, CaseType } from '@case-clinical/web/core/data-access'
import { TableViewComponent } from '@case-clinical/web/datatable/ui'

@Component({
  selector: 'ui-case-type-select-table-view',
  template: `
    <table-view
...
export class WebCaseTypeSelectTableViewComponent {
