...
import { currencyFormatter, dateFormatter, ContactSetting } from '@case-clinical/web/core/data-access'
import { TableViewComponent } from '@case-clinical/web/datatable/ui'

@Component({
  selector: 'ui-contact-setting-select-table-view',
  template: `
    <table-view
...
export class WebContactSettingSelectTableViewComponent {
