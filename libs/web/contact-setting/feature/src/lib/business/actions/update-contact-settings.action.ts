...
import {UserUpdateContactSettingInput} from '@case-clinical/shared/util/sdk';

export class UpdateContactSettingsAction extends ContactSettingBusinessActionBase<boolean> {
