...
export class CreateContactSettingAction extends ContactSettingBusinessActionBase<ContactSetting> {constructor(private input: UserCreateContactSettingInput) {
