...
export class CreateDurableMedicalEquipmentAction extends DurableMedicalEquipmentBusinessActionBase<DurableMedicalEquipment> {constructor(private input: UserCreateDurableMedicalEquipmentInput) {
