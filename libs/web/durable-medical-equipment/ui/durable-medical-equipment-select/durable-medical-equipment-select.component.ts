...
@Component({
  templateUrl: `./durable-medical-equipment-select.component.html`,
})
export class DurableMedicalEquipmentSelectComponent extends FieldType implements OnInit {
