...
export class CreateImplantCategoryAction extends ImplantCategoryBusinessActionBase<ImplantCategory> {constructor(private input: UserCreateImplantCategoryInput) {
