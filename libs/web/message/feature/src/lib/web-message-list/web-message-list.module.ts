...
import { WebMessageListComponent } from './web-message-list.component'
...
@NgModule({
  declarations: [WebMessageListComponent],
  imports: [
    ...
    RouterModule.forChild([{ path: '', component: WebMessageListComponent }]),

  ],
})
export class WebMessageListModule {}
