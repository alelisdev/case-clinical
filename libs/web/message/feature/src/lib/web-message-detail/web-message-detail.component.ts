...
import { Message } from '@case-clinical/web/core/data-access'

@Component({
  templateUrl: `./web-message-detail.component.html`,
  providers: [WebMessageDetailStore],
  encapsulation: ViewEncapsulation.None,
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class WebMessageDetailComponent implements AfterViewInit {
  @ViewChild('matDrawer', { static: true }) matDrawer: MatDrawer
  drawerMode: 'side' | 'over'
  drawerOpened: boolean
  menuData: FuseNavigationItem[] = []
  private _unsubscribeAll: Subject<any> = new Subject<any>()
  private _item: Message
  readonly vm$ = this.store.vm$

  constructor(
    private readonly store: WebMessageDetailStore,
