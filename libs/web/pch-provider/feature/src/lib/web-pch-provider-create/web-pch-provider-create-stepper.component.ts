...
import { WebPchProviderCreateStore } from './web-pch-provider-create.store'
import { ActivatedRoute,Router } from '@angular/router'
import { FormlyFieldConfig } from '@ngx-formly/core'
import { map, pluck } from 'rxjs/operators'

@Component({
  templateUrl: './web-pch-provider-create.component.html',
  providers: [WebPchProviderCreateStore],
})
export class WebPchProviderCreateComponent {
...
className: 'w-full sm:w-1/2 md:w-1/4  px-1'
  ...
  constructor(
    private readonly store: WebPchProviderCreateStore,
  ...
  createPchProvider(input) {
    ...
    this.store.createPchProviderEffect(input)
  }
}
