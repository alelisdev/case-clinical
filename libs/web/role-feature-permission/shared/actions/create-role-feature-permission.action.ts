...
export class CreateRoleFeaturePermissionAction extends RoleFeaturePermissionBusinessActionBase<RoleFeaturePermission> {
  constructor(private input: UserCreateRoleFeaturePermissionInput) {
