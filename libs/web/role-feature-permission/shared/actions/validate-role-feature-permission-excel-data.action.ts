...
import { FeaturePermission, Role } from '@case-clinical/shared/util/sdk'
export class ValidateRoleFeaturePermissionExcelDataAction extends RoleFeaturePermissionBusinessActionBase<boolean> {
...
roles: Role[]
  ...
  constructor(excelData: any[], featurePermissions: FeaturePermission[], roles: Role[]) {
    ...
    this.excelData.map((datum, index) => {
      names.push(datum['name']);
            ...
            this.validationContext.addRule(
              new ImportSolutionRule(`featurePermissionName_${index}_is_valid}`, "Feature Permission Is Not Valid", 'featurePermission.name', datum['featurePermission'], this.featurePermissions, true)
            )
