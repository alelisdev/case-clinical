...
import {UserUpdateRoleFeaturePermissionInput} from '@case-clinical/shared/util/sdk';

export class UpdateRoleFeaturePermissionsAction extends RoleFeaturePermissionBusinessActionBase<boolean> {
