...
import { WebDiagnosisCodeDetailStore } from './web-diagnosis-code-detail.store'
import {
...
@Component({
  templateUrl: `./web-diagnosis-code-detail.component.html`,
  providers: [WebDiagnosisCodeDetailStore],
  encapsulation: ViewEncapsulation.None,
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class WebDiagnosisCodeDetailComponent implements AfterViewInit {
  @ViewChild('matDrawer', { static: true }) matDrawer: MatDrawer
  drawerMode: 'side' | 'over'
  drawerOpened: boolean
  menuData: FuseNavigationItem[] = []
  private _unsubscribeAll: Subject<any> = new Subject<any>()
  private _item: DiagnosisCode
  readonly vm$ = this.store.vm$

  constructor(
    private readonly store: WebDiagnosisCodeDetailStore,
