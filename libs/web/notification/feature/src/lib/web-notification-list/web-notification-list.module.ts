...
import { WebNotificationListComponent } from './web-notification-list.component'
...
@NgModule({
  declarations: [WebNotificationListComponent],
  imports: [
    ...
    RouterModule.forChild([{ path: '', component: WebNotificationListComponent }]),

  ],
})
export class WebNotificationListModule {}
