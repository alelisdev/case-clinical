...
import { WebPaymentDetailStore } from './web-payment-detail.store'
import {
...
@Component({
  templateUrl: `./web-payment-detail.component.html`,
  providers: [WebPaymentDetailStore],
  encapsulation: ViewEncapsulation.None,
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class WebPaymentDetailComponent implements AfterViewInit {
  ...
  constructor(
    private readonly store: WebPaymentDetailStore,
