...
import { WebAuthorizationDetailStore } from './web-authorization-detail.store'
import {
...
@Component({
  templateUrl: `./web-authorization-detail.component.html`,
  providers: [WebAuthorizationDetailStore],
  encapsulation: ViewEncapsulation.None,
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class WebAuthorizationDetailComponent implements AfterViewInit {
  @ViewChild('matDrawer', { static: true }) matDrawer: MatDrawer
  drawerMode: 'side' | 'over'
  drawerOpened: boolean
  menuData: FuseNavigationItem[] = []
  private _unsubscribeAll: Subject<any> = new Subject<any>()
  private _item: Authorization
  readonly vm$ = this.store.vm$

  constructor(
    private readonly store: WebAuthorizationDetailStore,
