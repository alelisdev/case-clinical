...
@Injectable()
export class WebRoleEditStore extends ComponentStore<RoleEditState> {
  constructor(
    ...
    this.loadRoleEffect(route.params.pipe(map((route) => route?.roleId)))
  }
  ...
  readonly updateRoleEffect = this.effect<UserUpdateRoleInput>((input$) =>
    input$.pipe(
      ...
      switchMap(([input, item]) =>
         this.roleService.updateRole(input, item?.id).pipe(
          tapResponse(
            (response: any) => {
