...
import { currencyFormatter, dateFormatter, BodyPartLead } from '@case-clinical/web/core/data-access'
import { TableViewComponent } from '@case-clinical/web/datatable/ui'

@Component({
  selector: 'ui-body-part-lead-select-table-view',
  template: `
    <table-view
...
export class WebBodyPartLeadSelectTableViewComponent {
