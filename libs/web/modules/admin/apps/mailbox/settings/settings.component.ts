...
import { MailLabel } from 'libs/web/modules/admin/apps/mailbox/mailbox.types';
import { labelColorDefs, labelColors } from 'libs/web/modules/admin/apps/mailbox/mailbox.constants';
