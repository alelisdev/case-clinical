...
import { NotesDetailsComponent } from 'libs/web/modules/admin/apps/notes/details/details.component';
import { NotesLabelsComponent } from 'libs/web/modules/admin/apps/notes/labels/labels.component';
import { NotesService } from 'libs/web/modules/admin/apps/notes/notes.service';
import { Label, Note } from 'libs/web/modules/admin/apps/notes/notes.types';
