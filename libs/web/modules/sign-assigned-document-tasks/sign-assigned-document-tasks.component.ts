...
@Component({
    selector       : 'sign-assigned-document-tasks',
    templateUrl    : './sign-assigned-document-tasks.component.html',
    styleUrls      : ['./sign-assigned-document-tasks.component.scss'],
    encapsulation  : ViewEncapsulation.None,
    changeDetection: ChangeDetectionStrategy.OnPush
})
export class SignAssignedDocumentTasksComponent implements OnInit, OnDestroy
{
