...
import { WebFirmDetailComponent } from './web-firm-detail.component'
import { WebFirmOverviewComponent } from './overview/overview.component'
...
@NgModule({
  declarations: [
    WebFirmDetailComponent,

    WebFirmOverviewComponent
],
  imports: [
    MatButtonModule,
    MatIconModule,
    ...
    RouterModule.forChild([
        { path: '', 
           component: WebFirmDetailComponent,
           children: [
             {
               path: 'overview',
               pathMatch: 'full',
               component: WebFirmOverviewComponent
             },
            {
              path: 'edit',
              loadChildren: () => import('../web-firm-edit/web-firm-edit.module').then((m) => m.WebFirmEditModule),
            },
          {
                  path: 'attorneys',
...
export class WebFirmDetailModule {}
