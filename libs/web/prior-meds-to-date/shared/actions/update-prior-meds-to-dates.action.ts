...
import {UserUpdatePriorMedsToDateInput, UpdateResult} from '@case-clinical/shared/util/sdk';

export class UpdatePriorMedsToDatesAction extends PriorMedsToDateBusinessActionBase<UpdateResult> {
