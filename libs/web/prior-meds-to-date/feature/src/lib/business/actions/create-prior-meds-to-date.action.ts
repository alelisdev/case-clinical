...
export class CreatePriorMedsToDateAction extends PriorMedsToDateBusinessActionBase<PriorMedsToDate> {constructor(private input: UserCreatePriorMedsToDateInput) {
