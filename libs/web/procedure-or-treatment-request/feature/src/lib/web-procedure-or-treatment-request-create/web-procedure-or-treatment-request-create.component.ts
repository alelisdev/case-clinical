...
@Component({templateUrl: './web-procedure-or-treatment-request-create.component.html',
  providers: [WebProcedureOrTreatmentRequestFeatureStore],
})
export class WebProcedureOrTreatmentRequestCreateComponent implements OnInit, OnDestroy {
