...
import { WebBodyPartDetailStore } from './web-body-part-detail.store'
import {
...
@Component({
  templateUrl: `./web-body-part-detail.component.html`,
  providers: [WebBodyPartDetailStore],
  encapsulation: ViewEncapsulation.None,
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class WebBodyPartDetailComponent implements AfterViewInit {
  @ViewChild('matDrawer', { static: true }) matDrawer: MatDrawer
  drawerMode: 'side' | 'over'
  drawerOpened: boolean
  menuData: FuseNavigationItem[] = []
  private _unsubscribeAll: Subject<any> = new Subject<any>()
  private _item: BodyPart
  readonly vm$ = this.store.vm$

  constructor(
    private readonly store: WebBodyPartDetailStore,
