...
import { WebGenderDetailStore } from './web-gender-detail.store'
import {
...
@Component({
  templateUrl: `./web-gender-detail.component.html`,
  providers: [WebGenderDetailStore],
  encapsulation: ViewEncapsulation.None,
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class WebGenderDetailComponent implements AfterViewInit {
  @ViewChild('matDrawer', { static: true }) matDrawer: MatDrawer
  drawerMode: 'side' | 'over'
  drawerOpened: boolean
  menuData: FuseNavigationItem[] = []
  private _unsubscribeAll: Subject<any> = new Subject<any>()
  private _item: Gender
  readonly vm$ = this.store.vm$

  constructor(
    private readonly store: WebGenderDetailStore,
