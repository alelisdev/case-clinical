...
import {UserUpdateAttorneyTypeInput} from '@case-clinical/shared/util/sdk';

export class UpdateAttorneyTypesAction extends AttorneyTypeBusinessActionBase<boolean> {
