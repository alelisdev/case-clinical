...
export class ShortcutsComponent implements OnInit, OnDestroy {
    @ViewChild('shortcutsOrigin') private _shortcutsOrigin: MatButton | undefined
    @ViewChild('shortcutsPanel') private _shortcutsPanel: TemplateRef<any> | undefined

    mode: 'view' | 'modify' | 'add' | 'edit' = 'view'
    shortcutForm: FormGroup | undefined
