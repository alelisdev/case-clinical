...
import {UserUpdatePatientTreatmentStatusInput} from '@case-clinical/shared/util/sdk';

export class UpdatePatientTreatmentStatusesAction extends PatientTreatmentStatusBusinessActionBase<boolean> {
