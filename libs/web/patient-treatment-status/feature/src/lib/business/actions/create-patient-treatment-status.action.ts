...
export class CreatePatientTreatmentStatusAction extends PatientTreatmentStatusBusinessActionBase<PatientTreatmentStatus> {constructor(private input: UserCreatePatientTreatmentStatusInput) {
