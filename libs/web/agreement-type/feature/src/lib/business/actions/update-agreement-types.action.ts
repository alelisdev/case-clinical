...
import {UserUpdateAgreementTypeInput} from '@case-clinical/shared/util/sdk';

export class UpdateAgreementTypesAction extends AgreementTypeBusinessActionBase<boolean> {
