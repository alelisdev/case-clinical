...
import { WebAgreementTypeDetailStore } from './web-agreement-type-detail.store'
import {
...
@Component({
  templateUrl: `./web-agreement-type-detail.component.html`,
  providers: [WebAgreementTypeDetailStore],
  encapsulation: ViewEncapsulation.None,
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class WebAgreementTypeDetailComponent implements AfterViewInit {
  @ViewChild('matDrawer', { static: true }) matDrawer: MatDrawer
  drawerMode: 'side' | 'over'
  drawerOpened: boolean
  menuData: FuseNavigationItem[] = []
  private _unsubscribeAll: Subject<any> = new Subject<any>()
  private _item: AgreementType
  readonly vm$ = this.store.vm$

  constructor(
    private readonly store: WebAgreementTypeDetailStore,
