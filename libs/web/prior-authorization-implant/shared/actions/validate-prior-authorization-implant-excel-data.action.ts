...
import { Implant, PriorAuthorizationRequest } from '@case-clinical/shared/util/sdk'
export class ValidatePriorAuthorizationImplantExcelDataAction extends PriorAuthorizationImplantBusinessActionBase<boolean> {
...
priorAuthorizationRequests: PriorAuthorizationRequest[]
  ...
  constructor(excelData: any[], implants: Implant[], priorAuthorizationRequests: PriorAuthorizationRequest[]) {
    ...
    this.excelData.map((datum, index) => {
      names.push(datum['name']);
            ...
            this.validationContext.addRule(
              new ImportSolutionRule(`implantName_${index}_is_valid}`, "Implant Is Not Valid", 'implant.name', datum['implant'], this.implants, true)
            )
