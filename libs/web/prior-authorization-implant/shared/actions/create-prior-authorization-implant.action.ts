...
export class CreatePriorAuthorizationImplantAction extends PriorAuthorizationImplantBusinessActionBase<PriorAuthorizationImplant> {
  constructor(private input: UserCreatePriorAuthorizationImplantInput) {
