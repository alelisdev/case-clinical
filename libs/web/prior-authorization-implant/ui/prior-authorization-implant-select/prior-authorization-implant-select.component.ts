...
@Component({
  templateUrl: `./prior-authorization-implant-select.component.html`,
})
export class PriorAuthorizationImplantSelectComponent extends FieldType implements OnInit {
