...
import {UserUpdatePriorAuthorizationImplantInput} from '@case-clinical/shared/util/sdk';

export class UpdatePriorAuthorizationImplantsAction extends PriorAuthorizationImplantBusinessActionBase<boolean> {
