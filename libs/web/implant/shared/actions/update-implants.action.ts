...
import {UserUpdateImplantInput, UpdateResult} from '@case-clinical/shared/util/sdk';

export class UpdateImplantsAction extends ImplantBusinessActionBase<UpdateResult> {
