...
import { currencyFormatter, dateFormatter, VendorLocation } from '@case-clinical/web/core/data-access'
import { TableViewComponent } from '@case-clinical/web/datatable/ui'

@Component({
  selector: 'ui-vendor-location-select-table-view',
  template: `
    <table-view
...
export class WebVendorLocationSelectTableViewComponent {
