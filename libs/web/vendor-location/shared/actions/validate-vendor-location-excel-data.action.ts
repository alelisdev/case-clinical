...
import { Location, Vendor } from '@case-clinical/shared/util/sdk'
export class ValidateVendorLocationExcelDataAction extends VendorLocationBusinessActionBase<boolean> {
...
vendors: Vendor[]
  ...
  constructor(excelData: any[], locations: Location[], vendors: Vendor[]) {
