...
{debounce: true})
  ...
  readonly filterReconciliationPeriodTypes = (term) => 
        this.data.userReconciliationPeriodTypes({input: { name: term}}).pipe(
          tapResponse(
            (res: any) => {
  ...
  readonly filterCalculationBasisTypes = (term) => 
        this.data.userCalculationBasisTypes({input: { name: term}}).pipe(
          tapResponse(
            (res: any) => {
  ...
  readonly filterProcesses = (term) => 
        this.data.userProcesses({input: { name: term}}).pipe(
          tapResponse(
            (res: any) => {
