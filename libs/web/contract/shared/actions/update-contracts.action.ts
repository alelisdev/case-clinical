...
import {UserUpdateContractInput, UpdateResult} from '@case-clinical/shared/util/sdk';

export class UpdateContractsAction extends ContractBusinessActionBase<UpdateResult> {
