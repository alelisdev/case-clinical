...
import { currencyFormatter, dateFormatter, FirmStatus } from '@case-clinical/web/core/data-access'
import { TableViewComponent } from '@case-clinical/web/datatable/ui'

@Component({
  selector: 'ui-firm-status-select-table-view',
  template: `
    <table-view
...
export class WebFirmStatusSelectTableViewComponent {
