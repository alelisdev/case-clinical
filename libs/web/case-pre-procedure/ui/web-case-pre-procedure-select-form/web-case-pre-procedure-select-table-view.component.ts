...
import { currencyFormatter, dateFormatter, CasePreProcedure } from '@case-clinical/web/core/data-access'
import { TableViewComponent } from '@case-clinical/web/datatable/ui'

@Component({
  selector: 'ui-case-pre-procedure-select-table-view',
  template: `
    <table-view
...
export class WebCasePreProcedureSelectTableViewComponent {
