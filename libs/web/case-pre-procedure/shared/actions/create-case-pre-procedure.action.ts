...
export class CreateCasePreProcedureAction extends CasePreProcedureBusinessActionBase<CasePreProcedure> {
  constructor(private input: UserCreateCasePreProcedureInput) {
