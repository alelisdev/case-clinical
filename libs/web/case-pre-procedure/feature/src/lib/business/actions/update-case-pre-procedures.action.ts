...
import {UserUpdateCasePreProcedureInput} from '@case-clinical/shared/util/sdk';

export class UpdateCasePreProceduresAction extends CasePreProcedureBusinessActionBase<boolean> {
