...
import {UserUpdateSettingInput, UpdateResult} from '@case-clinical/shared/util/sdk';

export class UpdateSettingsAction extends SettingBusinessActionBase<UpdateResult> {
