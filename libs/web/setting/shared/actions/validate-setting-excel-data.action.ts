...
import { User } from '@case-clinical/shared/util/sdk'
export class ValidateSettingExcelDataAction extends SettingBusinessActionBase<boolean> {
  ...
  constructor(excelData: any[], users: User[]) {
