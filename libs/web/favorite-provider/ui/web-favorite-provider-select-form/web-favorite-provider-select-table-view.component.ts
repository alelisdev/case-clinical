...
import { currencyFormatter, dateFormatter, FavoriteProvider } from '@case-clinical/web/core/data-access'
import { TableViewComponent } from '@case-clinical/web/datatable/ui'

@Component({
  selector: 'ui-favorite-provider-select-table-view',
  template: `
    <table-view
...
export class WebFavoriteProviderSelectTableViewComponent {
