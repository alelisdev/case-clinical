...
import {UserUpdateCasePreProblemInput, UpdateResult} from '@case-clinical/shared/util/sdk';

export class UpdateCasePreProblemsAction extends CasePreProblemBusinessActionBase<UpdateResult> {
