...
export class CreateCasePreProblemAction extends CasePreProblemBusinessActionBase<CasePreProblem> {constructor(private input: UserCreateCasePreProblemInput) {
