...
import { Service, ClinicalProvider } from '@case-clinical/shared/util/sdk'
export class ValidateClinicalProviderServiceExcelDataAction extends ClinicalProviderServiceBusinessActionBase<boolean> {
...
clinicalProviders: ClinicalProvider[]
  ...
  constructor(excelData: any[], services: Service[], clinicalProviders: ClinicalProvider[]) {
    ...
    this.excelData.map((datum, index) => {
      names.push(datum['name']);
            ...
            this.validationContext.addRule(
              new ImportSolutionRule(`serviceName_${index}_is_valid}`, "Service Is Not Valid", 'service.name', datum['service'], this.services, true)
            )
