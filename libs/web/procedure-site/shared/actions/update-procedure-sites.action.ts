...
import {UserUpdateProcedureSiteInput, UpdateResult} from '@case-clinical/shared/util/sdk';

export class UpdateProcedureSitesAction extends ProcedureSiteBusinessActionBase<UpdateResult> {
