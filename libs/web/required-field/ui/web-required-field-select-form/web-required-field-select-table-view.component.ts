...
import { currencyFormatter, dateFormatter, RequiredField } from '@case-clinical/web/core/data-access'
import { TableViewComponent } from '@case-clinical/web/datatable/ui'

@Component({
  selector: 'ui-required-field-select-table-view',
  template: `
    <table-view
...
export class WebRequiredFieldSelectTableViewComponent {
