...
@Component({
  templateUrl: `./contracted-rate-kind-select.component.html`,
})
export class ContractedRateKindSelectComponent extends FieldType implements OnInit {
