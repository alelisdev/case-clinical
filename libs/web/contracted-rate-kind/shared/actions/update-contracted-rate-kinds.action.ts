...
import {UserUpdateContractedRateKindInput, UpdateResult} from '@case-clinical/shared/util/sdk';

export class UpdateContractedRateKindsAction extends ContractedRateKindBusinessActionBase<UpdateResult> {
