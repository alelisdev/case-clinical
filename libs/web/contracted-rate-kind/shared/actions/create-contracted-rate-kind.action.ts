...
export class CreateContractedRateKindAction extends ContractedRateKindBusinessActionBase<ContractedRateKind> {
  constructor(private input: UserCreateContractedRateKindInput) {
