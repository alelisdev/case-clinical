...
import { currencyFormatter, dateFormatter, MedicalConditionProvider } from '@case-clinical/web/core/data-access'
import { TableViewComponent } from '@case-clinical/web/datatable/ui'

@Component({
  selector: 'ui-medical-condition-provider-select-table-view',
  template: `
    <table-view
      ...
      [data]="medicalConditionProviders"
...
export class WebMedicalConditionProviderSelectTableViewComponent {
