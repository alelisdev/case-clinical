...
export class CreateProcedureVendorAction extends ProcedureVendorBusinessActionBase<ProcedureVendor> {constructor(private input: UserCreateProcedureVendorInput) {
