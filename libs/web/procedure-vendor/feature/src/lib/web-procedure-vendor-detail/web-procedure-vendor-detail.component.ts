...
import { WebProcedureVendorDetailStore } from './web-procedure-vendor-detail.store'
import {
...
@Component({
  templateUrl: `./web-procedure-vendor-detail.component.html`,
  providers: [WebProcedureVendorDetailStore],
  encapsulation: ViewEncapsulation.None,
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class WebProcedureVendorDetailComponent implements AfterViewInit {
  @ViewChild('matDrawer', { static: true }) matDrawer: MatDrawer
  drawerMode: 'side' | 'over'
  drawerOpened: boolean
  menuData: FuseNavigationItem[] = []
  private _unsubscribeAll: Subject<any> = new Subject<any>()
  private _item: ProcedureVendor
  readonly vm$ = this.store.vm$

  constructor(
    private readonly store: WebProcedureVendorDetailStore,
