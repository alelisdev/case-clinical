...
import { currencyFormatter, dateFormatter, ProcedureType } from '@case-clinical/web/core/data-access'
import { TableViewComponent } from '@case-clinical/web/datatable/ui'

@Component({
  selector: 'ui-procedure-type-select-table-view',
  template: `
    <table-view
...
export class WebProcedureTypeSelectTableViewComponent {
