...
export class CreateContactPhoneNumberAction extends ContactPhoneNumberBusinessActionBase<ContactPhoneNumber> {
  constructor(private input: UserCreateContactPhoneNumberInput) {
