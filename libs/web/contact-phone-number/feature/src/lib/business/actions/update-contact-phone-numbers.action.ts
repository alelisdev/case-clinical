...
import {UserUpdateContactPhoneNumberInput} from '@case-clinical/shared/util/sdk';

export class UpdateContactPhoneNumbersAction extends ContactPhoneNumberBusinessActionBase<boolean> {
