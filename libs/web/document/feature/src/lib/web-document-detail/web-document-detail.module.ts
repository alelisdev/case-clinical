...
import { WebDocumentDetailComponent } from './web-document-detail.component'
import { WebDocumentOverviewComponent } from './overview/overview.component'
...
@NgModule({
  declarations: [
    WebDocumentDetailComponent,

    WebDocumentOverviewComponent
],
  imports: [
    MatButtonModule,
    MatIconModule,
    ...
    RouterModule.forChild([
        { path: '', 
           component: WebDocumentDetailComponent,
           children: [
             {
               path: 'overview',
               pathMatch: 'full',
               component: WebDocumentOverviewComponent
             },
            {
              path: 'edit',
              loadChildren: () => import('../web-document-edit/web-document-edit.module').then((m) => m.WebDocumentEditModule),
            },
          {
...
export class WebDocumentDetailModule {}
