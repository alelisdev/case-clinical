...
import { WebCaseProcedureDetailComponent } from './web-case-procedure-detail.component'
import { WebCaseProcedureOverviewComponent } from './overview/overview.component'
...
@NgModule({
  declarations: [
    WebCaseProcedureDetailComponent,

    WebCaseProcedureOverviewComponent
],
  imports: [
    MatButtonModule,
    MatIconModule,
    ...
    RouterModule.forChild([
        { path: '', 
           component: WebCaseProcedureDetailComponent,
           children: [
             {
               path: 'overview',
               pathMatch: 'full',
               component: WebCaseProcedureOverviewComponent
             },
            {
              path: 'edit',
              loadChildren: () => import('../web-case-procedure-edit/web-case-procedure-edit.module').then((m) => m.WebCaseProcedureEditModule),
            },
          {
...
export class WebCaseProcedureDetailModule {}
