...
import {UserUpdateCaseProcedureInput} from '@case-clinical/shared/util/sdk';

export class UpdateCaseProceduresAction extends CaseProcedureBusinessActionBase<boolean> {
