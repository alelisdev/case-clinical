...
import { LegalCase, Appointment, Location } from '@case-clinical/shared/util/sdk'
export class ValidateCaseProcedureExcelDataAction extends CaseProcedureBusinessActionBase<boolean> {
...
locations: Location[]
  ...
  constructor(excelData: any[], legalCases: LegalCase[], appointments: Appointment[], locations: Location[]) {
