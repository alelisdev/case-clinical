...
import { currencyFormatter, dateFormatter, Award } from '@case-clinical/web/core/data-access'
import { TableViewComponent } from '@case-clinical/web/datatable/ui'

@Component({
  selector: 'ui-award-select-table-view',
  template: `
    <table-view
...
export class WebAwardSelectTableViewComponent {
