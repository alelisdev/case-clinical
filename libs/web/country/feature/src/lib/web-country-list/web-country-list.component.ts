...
import { WebCountrySelectTableViewComponent } from '@case-clinical/web/country/ui';
...
@Component({
  template: `
    <ng-container *featureFlag="'Country.View'">
...
export class WebCountryListComponent implements OnInit {
  @ViewChild(WebCountrySelectTableViewComponent) tableView: WebCountrySelectTableViewComponent
