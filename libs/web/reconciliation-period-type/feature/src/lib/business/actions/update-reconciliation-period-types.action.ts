...
import {UserUpdateReconciliationPeriodTypeInput} from '@case-clinical/shared/util/sdk';

export class UpdateReconciliationPeriodTypesAction extends ReconciliationPeriodTypeBusinessActionBase<boolean> {
