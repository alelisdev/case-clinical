...
import { Lead } from '@case-clinical/shared/util/sdk'
export class ValidateLeadActionExcelDataAction extends LeadActionBusinessActionBase<boolean> {
  ...
  constructor(excelData: any[], leads: Lead[]) {
