...
export class ValidateMedicalRecordStatusExcelDataAction extends MedicalRecordStatusBusinessActionBase<boolean> {
  ...
  constructor(excelData: any[]) {
    super('ValidateMedicalRecordStatusExcelDataAction')
