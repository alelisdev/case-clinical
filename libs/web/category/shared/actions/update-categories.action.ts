...
import {UserUpdateCategoryInput, UpdateResult} from '@case-clinical/shared/util/sdk';

export class UpdateCategoriesAction extends CategoryBusinessActionBase<UpdateResult> {
