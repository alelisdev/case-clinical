...
import {UserUpdatePaymentTypeInput} from '@case-clinical/shared/util/sdk';

export class UpdatePaymentTypesAction extends PaymentTypeBusinessActionBase<boolean> {
