...
import { currencyFormatter, dateFormatter, LeadInjury } from '@case-clinical/web/core/data-access'
import { TableViewComponent } from '@case-clinical/web/datatable/ui'

@Component({
  selector: 'ui-lead-injury-select-table-view',
  template: `
    <table-view
...
export class WebLeadInjurySelectTableViewComponent {
