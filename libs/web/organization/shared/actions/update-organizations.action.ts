...
import {UserUpdateOrganizationInput, UpdateResult} from '@case-clinical/shared/util/sdk';

export class UpdateOrganizationsAction extends OrganizationBusinessActionBase<UpdateResult> {
