...
import { currencyFormatter, dateFormatter, ProcedureOrTreatmentRequestAuthorization } from '@case-clinical/web/core/data-access'
import { TableViewComponent } from '@case-clinical/web/datatable/ui'

@Component({
  selector: 'ui-procedure-or-treatment-request-authorization-select-table-view',
  template: `
    <table-view
      ...
      [data]="procedureOrTreatmentRequestAuthorizations"
      [showSidebar]="false"
...
export class WebProcedureOrTreatmentRequestAuthorizationSelectTableViewComponent {
