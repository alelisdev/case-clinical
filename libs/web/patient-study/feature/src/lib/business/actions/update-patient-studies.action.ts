...
import {UserUpdatePatientStudyInput} from '@case-clinical/shared/util/sdk';

export class UpdatePatientStudiesAction extends PatientStudyBusinessActionBase<boolean> {
