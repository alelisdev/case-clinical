...
import { UserCreateChatInput, WebCoreDataAccessService, Chat, User } from '@case-clinical/web/core/data-access'
...
@Injectable()
export class WebChatCreateStore extends ComponentStore<ChatCreateState> {
