...
import { WebChatListComponent } from './web-chat-list.component'
...
@NgModule({
  declarations: [WebChatListComponent],
  imports: [
    ...
    RouterModule.forChild([{ path: '', component: WebChatListComponent }]),

  ],
})
export class WebChatListModule {}
