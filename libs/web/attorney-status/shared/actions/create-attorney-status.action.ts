...
export class CreateAttorneyStatusAction extends AttorneyStatusBusinessActionBase<AttorneyStatus> {
  constructor(private input: UserCreateAttorneyStatusInput) {
