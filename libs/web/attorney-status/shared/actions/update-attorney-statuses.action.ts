...
import {UserUpdateAttorneyStatusInput, UpdateResult} from '@case-clinical/shared/util/sdk';

export class UpdateAttorneyStatusesAction extends AttorneyStatusBusinessActionBase<UpdateResult> {
