...
import {UserUpdateJournalEntryInput} from '@case-clinical/shared/util/sdk';

export class UpdateJournalEntriesAction extends JournalEntryBusinessActionBase<boolean> {
