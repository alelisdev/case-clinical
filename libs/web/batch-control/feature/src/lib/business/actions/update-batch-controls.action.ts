...
import {UserUpdateBatchControlInput} from '@case-clinical/shared/util/sdk';

export class UpdateBatchControlsAction extends BatchControlBusinessActionBase<boolean> {
