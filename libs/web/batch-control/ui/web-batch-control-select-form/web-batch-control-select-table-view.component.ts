...
import { currencyFormatter, dateFormatter, BatchControl } from '@case-clinical/web/core/data-access'
import { TableViewComponent } from '@case-clinical/web/datatable/ui'

@Component({
  selector: 'ui-batch-control-select-table-view',
  template: `
    <table-view
...
export class WebBatchControlSelectTableViewComponent {
