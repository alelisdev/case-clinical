...
export class CreateSurgicalPositionAction extends SurgicalPositionBusinessActionBase<SurgicalPosition> {
  constructor(private input: UserCreateSurgicalPositionInput) {
