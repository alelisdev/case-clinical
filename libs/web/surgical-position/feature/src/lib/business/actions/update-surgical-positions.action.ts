...
import {UserUpdateSurgicalPositionInput} from '@case-clinical/shared/util/sdk';

export class UpdateSurgicalPositionsAction extends SurgicalPositionBusinessActionBase<boolean> {
