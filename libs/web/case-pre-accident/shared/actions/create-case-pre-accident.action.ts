...
export class CreateCasePreAccidentAction extends CasePreAccidentBusinessActionBase<CasePreAccident> {
  constructor(private input: UserCreateCasePreAccidentInput) {
