...
import {UserUpdateSpecialtyInput, UpdateResult} from '@case-clinical/shared/util/sdk';

export class UpdateSpecialtiesAction extends SpecialtyBusinessActionBase<UpdateResult> {
