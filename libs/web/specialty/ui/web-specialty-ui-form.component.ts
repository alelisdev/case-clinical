...
import { WebSpecialtyFormStore } from './web-specialty-form.store'
...
@Component({
  ...
  providers: [WebSpecialtyFormStore],
  template: `
    <div class="md:px-2 lg:px-0 lg:col-span-9 dark:bg-gray-800 bg-white rounded-lg shadow p-4">
      <div class="px-6 pt-6">
        <ui-form (submitForm)="submit($any(specialty))" [model]="specialty ?? {}" [fields]="fields" [form]="form">
          <div
...
export class WebFormsUiSpecialtyComponent
    {
...
,
  ...
  constructor(
    private readonly store: WebSpecialtyFormStore,
  ...
  async submit({ name,active }) {
    ...
    await this.store.createSpecialtyEffect({ name,active })
