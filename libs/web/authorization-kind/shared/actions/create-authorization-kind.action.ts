...
export class CreateAuthorizationKindAction extends AuthorizationKindBusinessActionBase<AuthorizationKind> {
  constructor(private input: UserCreateAuthorizationKindInput) {
