...
import {UserUpdatePriorAuthGuidelineInput} from '@case-clinical/shared/util/sdk';

export class UpdatePriorAuthGuidelinesAction extends PriorAuthGuidelineBusinessActionBase<boolean> {
