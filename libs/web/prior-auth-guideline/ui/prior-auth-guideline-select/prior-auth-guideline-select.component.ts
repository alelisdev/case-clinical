...
@Component({
  templateUrl: `./prior-auth-guideline-select.component.html`,
})
export class PriorAuthGuidelineSelectComponent extends FieldType implements OnInit {
