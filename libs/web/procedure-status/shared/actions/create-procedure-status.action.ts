...
export class CreateProcedureStatusAction extends ProcedureStatusBusinessActionBase<ProcedureStatus> {
  constructor(private input: UserCreateProcedureStatusInput) {
