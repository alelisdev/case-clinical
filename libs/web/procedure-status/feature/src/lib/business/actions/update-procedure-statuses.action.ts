...
import {UserUpdateProcedureStatusInput} from '@case-clinical/shared/util/sdk';

export class UpdateProcedureStatusesAction extends ProcedureStatusBusinessActionBase<boolean> {
