...
import { WebCoreDataAccessService,UserCourseProgress } from '@case-clinical/web/core/data-access'
import { pluck,switchMap, tap } from 'rxjs/operators'
import { DescriptionListItem } from '@case-clinical/web/ui/description-list'
import { WebUiToastService } from '@case-clinical/web/ui/toast'

export interface UserCourseProgressDetailState {
  errors ?: any
  loading?: boolean
...
@Injectable()
export class WebUserCourseProgressDetailStore extends ComponentStore<UserCourseProgressDetailState> {
  constructor(
    ...
    super({ loading: false })
    this.loadUserCourseProgressEffect(route.params.pipe(pluck('userCourseProgressId')))
  }
...
{ label: 'Current Step', value: item?.currentStep },
            ...
            .pipe(
              tapResponse(
                ...
                {  
                    ...
                    return this.router.navigate(['/queues/user-course-progresses'])
                },
                (errors: any) =>
                  this.patchState({
                    loading: false,
