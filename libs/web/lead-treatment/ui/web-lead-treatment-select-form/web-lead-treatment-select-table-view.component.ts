...
import { currencyFormatter, dateFormatter, LeadTreatment } from '@case-clinical/web/core/data-access'
import { TableViewComponent } from '@case-clinical/web/datatable/ui'

@Component({
  selector: 'ui-lead-treatment-select-table-view',
  template: `
    <table-view
...
export class WebLeadTreatmentSelectTableViewComponent {
