...
import { WebCalendarWeekdayListComponent } from './web-calendar-weekday-list.component'
...
@NgModule({
  declarations: [WebCalendarWeekdayListComponent],
  imports: [
    ...
    RouterModule.forChild([{ path: '', component: WebCalendarWeekdayListComponent }]),

  ],
})
export class WebCalendarWeekdayListModule {}
