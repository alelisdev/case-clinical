...
@Component({
  templateUrl: `./prior-authorization-diagnosis-code-select.component.html`,
})
export class PriorAuthorizationDiagnosisCodeSelectComponent extends FieldType implements OnInit {
  ...
  openDialog<T>(
    ...
    }: { priorAuthorizationDiagnosisCode ?: T },
  ) {
