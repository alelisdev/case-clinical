...
import { currencyFormatter, dateFormatter, PriorAuthorizationDiagnosisCode } from '@case-clinical/web/core/data-access'
import { TableViewComponent } from '@case-clinical/web/datatable/ui'

@Component({
  selector: 'ui-prior-authorization-diagnosis-code-select-table-view',
  template: `
    <table-view
      ...
      [data]="priorAuthorizationDiagnosisCodes"
...
export class WebPriorAuthorizationDiagnosisCodeSelectTableViewComponent {
