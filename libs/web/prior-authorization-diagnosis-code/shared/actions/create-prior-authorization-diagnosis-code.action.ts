...
export class CreatePriorAuthorizationDiagnosisCodeAction extends PriorAuthorizationDiagnosisCodeBusinessActionBase<PriorAuthorizationDiagnosisCode> {
  constructor(private input: UserCreatePriorAuthorizationDiagnosisCodeInput) {
