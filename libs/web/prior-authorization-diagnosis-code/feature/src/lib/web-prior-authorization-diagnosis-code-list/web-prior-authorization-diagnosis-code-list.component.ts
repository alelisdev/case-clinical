...
import { WebPriorAuthorizationDiagnosisCodeSelectTableViewComponent } from '@case-clinical/web/prior-authorization-diagnosis-code/ui';
...
@Component({
  template: `
    <ng-container *featureFlag="'PriorAuthorizationDiagnosisCode.View'">
      <ng-container *ngIf="vm$ | async as vm">
        <ui-data-list
          class="h-full w-full"
          [data]="vm.priorAuthorizationDiagnosisCodes"
          [columnDefs]="columnDefs"
          [validateFunc]="validateImportData"
          [createNewFunc]="createNewFunc"
          (searchQueryDidChange)="searchQueryDidChange($event)"
          (excelDataHasBeenPopulated)="excelDataHasBeenPopulated($event)"
          tableName="priorAuthorizationDiagnosisCode"
          title="PriorAuthorizationDiagnosisCode"
        ></ui-data-list>
      </ng-container>
    </ng-container>
`,
...
export class WebPriorAuthorizationDiagnosisCodeListComponent implements OnInit {
  @ViewChild(WebPriorAuthorizationDiagnosisCodeSelectTableViewComponent) tableView: WebPriorAuthorizationDiagnosisCodeSelectTableViewComponent
