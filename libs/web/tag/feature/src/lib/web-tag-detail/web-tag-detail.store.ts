...
import { WebCoreDataAccessService,Tag } from '@case-clinical/web/core/data-access'
...
@Injectable()
export class WebTagDetailStore extends ComponentStore<TagDetailState> {
  constructor(
...
{debounce: true})
  ...
  readonly deleteTagEffect = this.effect<Tag>(
    (tag$) =>
      tag$.pipe(
        switchMap((tag) =>
          this.data
