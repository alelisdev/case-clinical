...
import { WebTagDetailStore } from './web-tag-detail.store'
import {
...
@Component({
  templateUrl: `./web-tag-detail.component.html`,
  providers: [WebTagDetailStore],
  encapsulation: ViewEncapsulation.None,
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class WebTagDetailComponent implements AfterViewInit {
  ...
  constructor(
    private readonly store: WebTagDetailStore,
