...
WebUiFormField.input('email', { label: 'Email' }, {className: 'w-1/4  px-1'}),
...
,
				WebUiFormField.fieldRow([
WebUiFormField.input('verifyToken', { label: 'Verify Token' }, {className: 'w-1/4  px-1'}),
WebUiFormField.date('verifyExpires', { label: 'Verify Expires' }, {className: 'w-1/4  px-1'})				])
,
				WebUiFormField.fieldRow([
WebUiFormField.input('ownerId', { label: 'Owner Id' }, {className: 'w-1/4  px-1', hide: true})				])
]
