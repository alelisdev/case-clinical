...
export class UserCalendarFormComponent
    {
...
WebUiFormField.input('calendarTypeId', { label: 'Calendar Type Id' }, {className: 'w-1/4  px-1', hide: true}),
...
WebUiFormField.input('calendarId', { label: 'Calendar Id' }, {className: 'w-1/4  px-1', hide: true})				])
]
