...
@NgModule({
  imports: [CommonModule, ReactiveFormsModule, FormlyModule.forRoot(FORMLY_TABS_FORMLY_CONFIG)],
  declarations: [TabsetComponent, TabComponent, FIELD_TYPE_COMPONENTS, VisiblePipe],
