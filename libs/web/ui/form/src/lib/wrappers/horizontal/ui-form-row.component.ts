...
@Component({
  ...
  <div class="w-full h-full">
    ...
    <div *ngIf="(!manualArrangement && (field.fieldGroup?.length === 0 || horizontalItems?.length === 0)) && to.showNoDataLabel" class="w-full py-3 text-center">There is no data to display</div>
...
export class UiFormRowComponent extends UiFormBaseField implements OnInit, OnDestroy {
