...
import { Contract } from '@case-clinical/shared/util/sdk'
export class ValidateContractTermExcelDataAction extends ContractTermBusinessActionBase<boolean> {
  ...
  constructor(excelData: any[], contracts: Contract[]) {
