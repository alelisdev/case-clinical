...
import {UserUpdateContractTermInput, UpdateResult} from '@case-clinical/shared/util/sdk';

export class UpdateContractTermsAction extends ContractTermBusinessActionBase<UpdateResult> {
