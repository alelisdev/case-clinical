...
import { currencyFormatter, dateFormatter, ClinicalProviderTag } from '@case-clinical/web/core/data-access'
import { TableViewComponent } from '@case-clinical/web/datatable/ui'

@Component({
  selector: 'ui-clinical-provider-tag-select-table-view',
  template: `
    <table-view
...
export class WebClinicalProviderTagSelectTableViewComponent {
