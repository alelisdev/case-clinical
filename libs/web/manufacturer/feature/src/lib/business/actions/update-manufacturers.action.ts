...
import {UserUpdateManufacturerInput} from '@case-clinical/shared/util/sdk';

export class UpdateManufacturersAction extends ManufacturerBusinessActionBase<boolean> {
