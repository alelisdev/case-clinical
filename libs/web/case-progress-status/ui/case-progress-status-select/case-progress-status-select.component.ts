...
@Component({
  templateUrl: `./case-progress-status-select.component.html`,
})
export class CaseProgressStatusSelectComponent extends FieldType implements OnInit {
