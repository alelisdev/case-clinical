...
export class CreateCaseProgressStatusAction extends CaseProgressStatusBusinessActionBase<CaseProgressStatus> {
  constructor(private input: UserCreateCaseProgressStatusInput) {
