...
import {UserUpdateCaseProgressStatusInput, UpdateResult} from '@case-clinical/shared/util/sdk';

export class UpdateCaseProgressStatusesAction extends CaseProgressStatusBusinessActionBase<UpdateResult> {
