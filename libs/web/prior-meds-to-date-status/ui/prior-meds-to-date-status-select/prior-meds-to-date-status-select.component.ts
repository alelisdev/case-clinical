...
@Component({
  templateUrl: `./prior-meds-to-date-status-select.component.html`,
})
export class PriorMedsToDateStatusSelectComponent extends FieldType implements OnInit {
