...
import {UserUpdatePriorMedsToDateStatusInput, UpdateResult} from '@case-clinical/shared/util/sdk';

export class UpdatePriorMedsToDateStatusesAction extends PriorMedsToDateStatusBusinessActionBase<UpdateResult> {
