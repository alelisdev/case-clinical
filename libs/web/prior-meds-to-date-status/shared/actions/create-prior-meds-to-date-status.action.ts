...
export class CreatePriorMedsToDateStatusAction extends PriorMedsToDateStatusBusinessActionBase<PriorMedsToDateStatus> {
  constructor(private input: UserCreatePriorMedsToDateStatusInput) {
