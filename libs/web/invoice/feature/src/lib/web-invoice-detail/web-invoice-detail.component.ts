...
import { WebInvoiceDetailStore } from './web-invoice-detail.store'
import {
...
@Component({
  templateUrl: `./web-invoice-detail.component.html`,
  providers: [WebInvoiceDetailStore],
  encapsulation: ViewEncapsulation.None,
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class WebInvoiceDetailComponent implements AfterViewInit {
  @ViewChild('matDrawer', { static: true }) matDrawer: MatDrawer
  drawerMode: 'side' | 'over'
  drawerOpened: boolean
  menuData: FuseNavigationItem[] = []
  private _unsubscribeAll: Subject<any> = new Subject<any>()
  private _item: Invoice
  readonly vm$ = this.store.vm$

  constructor(
    private readonly store: WebInvoiceDetailStore,
