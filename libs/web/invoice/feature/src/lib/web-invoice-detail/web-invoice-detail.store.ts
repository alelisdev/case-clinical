...
import { WebCoreDataAccessService,Invoice } from '@case-clinical/web/core/data-access'
...
@Injectable()
export class WebInvoiceDetailStore extends ComponentStore<InvoiceDetailState> {
  constructor(
...
{debounce: true})
  ...
  readonly deleteInvoiceEffect = this.effect<Invoice>(
    (invoice$) =>
      invoice$.pipe(
        switchMap((invoice) =>
          this.data
