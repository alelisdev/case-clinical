...
import {UserUpdateAccountStatusInput} from '@case-clinical/shared/util/sdk';

export class UpdateAccountStatusesAction extends AccountStatusBusinessActionBase<boolean> {
