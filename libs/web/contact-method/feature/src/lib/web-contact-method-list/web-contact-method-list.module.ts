...
import { WebContactMethodListComponent } from './web-contact-method-list.component'
...
@NgModule({
  declarations: [WebContactMethodListComponent],
  imports: [
    ...
    RouterModule.forChild([{ path: '', component: WebContactMethodListComponent }]),

  ],
})
export class WebContactMethodListModule {}
