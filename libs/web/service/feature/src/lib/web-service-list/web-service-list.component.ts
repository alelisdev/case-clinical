...
import { WebServiceSelectTableViewComponent } from '@case-clinical/web/service/ui';
...
@Component({
  template: `
    <ng-container *featureFlag="'Service.View'">
...
export class WebServiceListComponent implements OnInit {
  @ViewChild(WebServiceSelectTableViewComponent) tableView: WebServiceSelectTableViewComponent
