...
import {UserUpdateRolePermissionInput} from '@case-clinical/shared/util/sdk';

export class UpdateRolePermissionsAction extends RolePermissionBusinessActionBase<boolean> {
