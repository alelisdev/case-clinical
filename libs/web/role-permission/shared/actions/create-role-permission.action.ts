...
export class CreateRolePermissionAction extends RolePermissionBusinessActionBase<RolePermission> {
  constructor(private input: UserCreateRolePermissionInput) {
