...
@Component({
  templateUrl: `./prior-authorization-equipment-select.component.html`,
})
export class PriorAuthorizationEquipmentSelectComponent extends FieldType implements OnInit {
