...
export class CreatePriorAuthorizationEquipmentAction extends PriorAuthorizationEquipmentBusinessActionBase<PriorAuthorizationEquipment> {constructor(private input: UserCreatePriorAuthorizationEquipmentInput) {
