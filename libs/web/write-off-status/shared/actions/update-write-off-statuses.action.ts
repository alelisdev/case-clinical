...
import {UserUpdateWriteOffStatusInput, UpdateResult} from '@case-clinical/shared/util/sdk';

export class UpdateWriteOffStatusesAction extends WriteOffStatusBusinessActionBase<UpdateResult> {
