...
export class CreateWriteOffStatusAction extends WriteOffStatusBusinessActionBase<WriteOffStatus> {
  constructor(private input: UserCreateWriteOffStatusInput) {
