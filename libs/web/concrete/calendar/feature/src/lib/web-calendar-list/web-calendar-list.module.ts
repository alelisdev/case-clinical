...
import { WebCalendarListComponent } from './web-calendar-list.component'
...
@NgModule({
  declarations: [WebCalendarListComponent],
  imports: [
    ...
    RouterModule.forChild([{ path: '', component: WebCalendarListComponent }]),

  ],
})
export class WebCalendarListModule {}
