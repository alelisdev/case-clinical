...
@Component({
  templateUrl: `./user-feature-select.component.html`
  //changeDetection: ChangeDetectionStrategy.OnPush,
})
export class UserFeatureSelectComponent extends FieldType {
  ...
  getUserFeatureValue(value) {
    return { ...value, userFeatureId: this.model.userFeatureId }
  }
