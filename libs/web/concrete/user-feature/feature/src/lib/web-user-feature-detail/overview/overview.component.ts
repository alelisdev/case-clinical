...
import { WebUserFeatureDetailStore } from '../web-user-feature-detail.store'
...
@Component({
        ...
        >
          <div class="flex-1 bg-white rounded-lg shadow md:px-2 lg:px-0 lg:col-span-9 dark:bg-gray-800">
            ...
            <div class="flex w-full py-4 border-b border-gray-200 lg:w-1/2 sm:py-5 sm:gap-4 sm:px-6">
              ...
              <div class="px-4 py-5">
                <h3 class="text-lg leading-6 font-medium text-gray-900">Feature</h3>
              </div>
              ...
              <div class="border-t border-gray-200 px-4 py-5">
                <dl class="grid grid-cols-2 gap-x-4 gap-y-8 sm:grid-cols-3 xl:grid-cols-4">
                  ...
                  <div class="sm:col-span-1">
                    <dt class="text-sm font-medium text-gray-500">Feature Permissions</dt>
                    <dd class="mt-1 text-sm text-gray-900">{{ vm.item.featurePermissions ?? 'None' }}</dd>
                  </div>
  ...
  `,
  providers: [WebUserFeatureDetailStore],
})
export class WebUserFeatureOverviewComponent {
  readonly vm$ = this.store.vm$

  constructor(private readonly store: WebUserFeatureDetailStore) {}
