...
import { WebUserFeatureListComponent } from './web-user-feature-list.component'
...
@NgModule({
  declarations: [WebUserFeatureListComponent],
  imports: [
    ...
    RouterModule.forChild([{ path: '', component: WebUserFeatureListComponent }]),

  ],
})
export class WebUserFeatureListModule {}
