...
import { WebAssignedDocumentListComponent } from './web-assigned-document-list.component'
...
@NgModule({
  declarations: [WebAssignedDocumentListComponent],
  imports: [
    ...
    RouterModule.forChild([{ path: '', component: WebAssignedDocumentListComponent }]),

  ],
})
export class WebAssignedDocumentListModule {}
