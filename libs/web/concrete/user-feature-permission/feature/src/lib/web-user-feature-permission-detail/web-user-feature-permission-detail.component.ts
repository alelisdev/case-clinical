...
@Component({
  templateUrl: `./web-user-feature-permission-detail.component.html`,
  providers: [WebUserFeaturePermissionDetailStore],
  encapsulation: ViewEncapsulation.None,
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class WebUserFeaturePermissionDetailComponent implements AfterViewInit {
  @ViewChild('matDrawer', { static: true }) matDrawer: MatDrawer
  drawerMode: 'side' | 'over'
  drawerOpened: boolean
  menuData: FuseNavigationItem[] = []
  private _unsubscribeAll: Subject<any> = new Subject<any>()
  private _item: UserFeaturePermission
  readonly vm$ = this.store.vm$

  constructor(
    private readonly store: WebUserFeaturePermissionDetailStore,
