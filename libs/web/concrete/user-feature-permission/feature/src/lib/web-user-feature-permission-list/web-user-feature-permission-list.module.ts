...
import { WebUserFeaturePermissionListComponent } from './web-user-feature-permission-list.component'
...
@NgModule({
  declarations: [WebUserFeaturePermissionListComponent],
  imports: [
    ...
    RouterModule.forChild([{ path: '', component: WebUserFeaturePermissionListComponent }]),

  ],
})
export class WebUserFeaturePermissionListModule {}
