...
import { WebCoreDataAccessService, UserFeaturePermission, UserCreateUserFeaturePermissionInput, FeaturePermission,User } from '@case-clinical/web/core/data-access'
import { ComponentStore,tapResponse } from '@ngrx/component-store'
import { switchMap, tap, map } from 'rxjs/operators'

export interface UserFeaturePermissionFormState {
  errors?: any
  loading?: boolean
...
@Injectable()
export class WebUserFeaturePermissionFormStore extends ComponentStore<UserFeaturePermissionFormState> {
