...
import {UserUpdateGuidelineUsedInput, UpdateResult} from '@case-clinical/shared/util/sdk';

export class UpdateGuidelineUsedsAction extends GuidelineUsedBusinessActionBase<UpdateResult> {
