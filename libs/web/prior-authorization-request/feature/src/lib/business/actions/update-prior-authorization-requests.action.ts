...
import {UserUpdatePriorAuthorizationRequestInput} from '@case-clinical/shared/util/sdk';

export class UpdatePriorAuthorizationRequestsAction extends PriorAuthorizationRequestBusinessActionBase<boolean> {
