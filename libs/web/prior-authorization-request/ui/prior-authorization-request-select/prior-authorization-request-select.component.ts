...
@Component({
  templateUrl: `./prior-authorization-request-select.component.html`,
})
export class PriorAuthorizationRequestSelectComponent extends FieldType implements OnInit {
