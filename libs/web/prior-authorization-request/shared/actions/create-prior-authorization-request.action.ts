...
export class CreatePriorAuthorizationRequestAction extends PriorAuthorizationRequestBusinessActionBase<PriorAuthorizationRequest> {
  constructor(private input: UserCreatePriorAuthorizationRequestInput) {
