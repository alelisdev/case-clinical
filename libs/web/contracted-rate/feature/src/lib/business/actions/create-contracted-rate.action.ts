...
export class CreateContractedRateAction extends ContractedRateBusinessActionBase<ContractedRate> {constructor(private input: UserCreateContractedRateInput) {
