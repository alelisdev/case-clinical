...
import { Contact } from '@case-clinical/shared/util/sdk'
export class ValidateContactEmailExcelDataAction extends ContactEmailBusinessActionBase<boolean> {
  ...
  constructor(excelData: any[], contacts: Contact[]) {
