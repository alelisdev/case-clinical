...
import {UserUpdateContactEmailInput} from '@case-clinical/shared/util/sdk';

export class UpdateContactEmailsAction extends ContactEmailBusinessActionBase<boolean> {
