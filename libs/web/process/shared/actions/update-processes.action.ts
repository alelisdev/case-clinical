...
import {UserUpdateProcessInput, UpdateResult} from '@case-clinical/shared/util/sdk';

export class UpdateProcessesAction extends ProcessBusinessActionBase<UpdateResult> {
