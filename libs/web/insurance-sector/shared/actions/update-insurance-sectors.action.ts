...
import {UserUpdateInsuranceSectorInput, UpdateResult} from '@case-clinical/shared/util/sdk';

export class UpdateInsuranceSectorsAction extends InsuranceSectorBusinessActionBase<UpdateResult> {
