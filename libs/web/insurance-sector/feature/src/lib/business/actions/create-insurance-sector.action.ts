...
export class CreateInsuranceSectorAction extends InsuranceSectorBusinessActionBase<InsuranceSector> {constructor(private input: UserCreateInsuranceSectorInput) {
