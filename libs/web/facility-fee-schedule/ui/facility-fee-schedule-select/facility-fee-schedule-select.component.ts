...
@Component({
  templateUrl: `./facility-fee-schedule-select.component.html`,
})
export class FacilityFeeScheduleSelectComponent extends FieldType implements OnInit {
