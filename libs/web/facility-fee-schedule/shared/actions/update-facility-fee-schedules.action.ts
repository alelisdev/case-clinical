...
import {UserUpdateFacilityFeeScheduleInput, UpdateResult} from '@case-clinical/shared/util/sdk';

export class UpdateFacilityFeeSchedulesAction extends FacilityFeeScheduleBusinessActionBase<UpdateResult> {
