...
export class CreateFacilityFeeScheduleAction extends FacilityFeeScheduleBusinessActionBase<FacilityFeeSchedule> {
  constructor(private input: UserCreateFacilityFeeScheduleInput) {
