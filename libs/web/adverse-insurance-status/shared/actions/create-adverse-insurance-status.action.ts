...
export class CreateAdverseInsuranceStatusAction extends AdverseInsuranceStatusBusinessActionBase<AdverseInsuranceStatus> {
  constructor(private input: UserCreateAdverseInsuranceStatusInput) {
