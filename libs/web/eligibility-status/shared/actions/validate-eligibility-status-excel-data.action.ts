...
export class ValidateEligibilityStatusExcelDataAction extends EligibilityStatusBusinessActionBase<boolean> {
  ...
  constructor(excelData: any[]) {
    super('ValidateEligibilityStatusExcelDataAction')
