...
export class WebAssignedDocumentOverviewComponent {
  readonly vm$ = this.store.vm$

  constructor(private readonly store: WebAssignedDocumentDetailStore) {}
