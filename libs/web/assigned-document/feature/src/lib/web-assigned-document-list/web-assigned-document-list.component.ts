...
export class WebAssignedDocumentListComponent implements OnInit {
  ...
  columnDefs: ColDef[] = [{ field: 'document.name', filter: "'agSetColumnFilter'" },
{ field: 'template.name', filter: "'agSetColumnFilter'" },
{ field: 'documentType.name', filter: "'agSetColumnFilter'" },
{ field: 'user.name', filter: "'agSetColumnFilter'" },
