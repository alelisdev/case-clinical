...
export class CreatePaymentApplicationMethodAction extends PaymentApplicationMethodBusinessActionBase<PaymentApplicationMethod> {constructor(private input: UserCreatePaymentApplicationMethodInput) {
