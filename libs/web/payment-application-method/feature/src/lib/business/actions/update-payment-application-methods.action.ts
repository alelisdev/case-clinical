...
import {UserUpdatePaymentApplicationMethodInput} from '@case-clinical/shared/util/sdk';

export class UpdatePaymentApplicationMethodsAction extends PaymentApplicationMethodBusinessActionBase<boolean> {
