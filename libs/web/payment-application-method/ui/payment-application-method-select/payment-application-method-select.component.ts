...
@Component({
  templateUrl: `./payment-application-method-select.component.html`,
})
export class PaymentApplicationMethodSelectComponent extends FieldType implements OnInit {
