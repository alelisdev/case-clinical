...
import { currencyFormatter, dateFormatter, AuthorizationDiagnosisCode } from '@case-clinical/web/core/data-access'
import { TableViewComponent } from '@case-clinical/web/datatable/ui'

@Component({
  selector: 'ui-authorization-diagnosis-code-select-table-view',
  template: `
    <table-view
      ...
      [data]="authorizationDiagnosisCodes"
      [showSidebar]="false"
...
export class WebAuthorizationDiagnosisCodeSelectTableViewComponent {
