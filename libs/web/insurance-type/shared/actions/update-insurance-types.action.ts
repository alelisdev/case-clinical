...
import {UserUpdateInsuranceTypeInput, UpdateResult} from '@case-clinical/shared/util/sdk';

export class UpdateInsuranceTypesAction extends InsuranceTypeBusinessActionBase<UpdateResult> {
