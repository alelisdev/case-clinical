...
import {UserUpdateCaseAccountPaymentInput, UpdateResult} from '@case-clinical/shared/util/sdk';

export class UpdateCaseAccountPaymentsAction extends CaseAccountPaymentBusinessActionBase<UpdateResult> {
