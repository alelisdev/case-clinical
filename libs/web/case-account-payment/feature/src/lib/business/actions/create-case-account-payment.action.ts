...
export class CreateCaseAccountPaymentAction extends CaseAccountPaymentBusinessActionBase<CaseAccountPayment> {constructor(private input: UserCreateCaseAccountPaymentInput) {
