...
import { WebFeeScheduleSelectTableViewComponent } from '@case-clinical/web/fee-schedule/ui';
...
@Component({
  template: `
    <ng-container *featureFlag="'FeeSchedule.View'">
      <ng-container *ngIf="vm$ | async as vm">
        <ui-data-list
          class="h-full w-full"
          [data]="vm.feeSchedules"
...
export class WebFeeScheduleListComponent implements OnInit {
  @ViewChild(WebFeeScheduleSelectTableViewComponent) tableView: WebFeeScheduleSelectTableViewComponent
