...
import {UserUpdateFeeScheduleInput} from '@case-clinical/shared/util/sdk';

export class UpdateFeeSchedulesAction extends FeeScheduleBusinessActionBase<boolean> {
