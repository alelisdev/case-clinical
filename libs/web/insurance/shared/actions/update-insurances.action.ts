...
import {UserUpdateInsuranceInput, UpdateResult} from '@case-clinical/shared/util/sdk';

export class UpdateInsurancesAction extends InsuranceBusinessActionBase<UpdateResult> {
