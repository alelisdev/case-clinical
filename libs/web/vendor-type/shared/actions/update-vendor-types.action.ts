...
import {UserUpdateVendorTypeInput, UpdateResult} from '@case-clinical/shared/util/sdk';

export class UpdateVendorTypesAction extends VendorTypeBusinessActionBase<UpdateResult> {
