...
import { currencyFormatter, dateFormatter, RecommendedOrder } from '@case-clinical/web/core/data-access'
import { TableViewComponent } from '@case-clinical/web/datatable/ui'

@Component({
  selector: 'ui-recommended-order-select-table-view',
  template: `
    <table-view
...
export class WebRecommendedOrderSelectTableViewComponent {
