...
@Component({
  selector: 'auth-normal-settings',
  templateUrl: './normal-settings.component.html',
  styleUrls: ['./normal-settings.component.scss']
})
export class NormalSettingsComponent implements OnInit {
