...
import { CaseAccount } from '@case-clinical/shared/util/sdk'
export class ValidateJournalEntryTemplateExcelDataAction extends JournalEntryTemplateBusinessActionBase<boolean> {
  ...
  constructor(excelData: any[], caseAccounts: CaseAccount[]) {
