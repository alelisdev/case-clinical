...
import { WebJournalEntryTemplateSelectTableViewComponent } from '@case-clinical/web/journal-entry-template/ui';
...
@Component({
  template: `
    <ng-container *featureFlag="'JournalEntryTemplate.View'">
      <ng-container *ngIf="vm$ | async as vm">
        <ui-data-list
          class="h-full w-full"
          [data]="vm.journalEntryTemplates"
          ...
          title="JournalEntryTemplate"
        ></ui-data-list>
      </ng-container>
    </ng-container>
`,
  providers: [
    WebJournalEntryTemplateFeatureStore,
    WebCaseAccountFeatureStore
],

})
export class WebJournalEntryTemplateListComponent implements OnInit {
  @ViewChild(WebJournalEntryTemplateSelectTableViewComponent) tableView: WebJournalEntryTemplateSelectTableViewComponent
