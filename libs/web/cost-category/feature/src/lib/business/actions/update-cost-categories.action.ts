...
import {UserUpdateCostCategoryInput} from '@case-clinical/shared/util/sdk';

export class UpdateCostCategoriesAction extends CostCategoryBusinessActionBase<boolean> {
