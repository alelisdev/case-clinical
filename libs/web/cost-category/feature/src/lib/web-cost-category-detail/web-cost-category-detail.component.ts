...
import { WebCostCategoryDetailStore } from './web-cost-category-detail.store'
import {
...
@Component({
  templateUrl: `./web-cost-category-detail.component.html`,
  providers: [WebCostCategoryDetailStore],
  encapsulation: ViewEncapsulation.None,
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class WebCostCategoryDetailComponent implements AfterViewInit {
  @ViewChild('matDrawer', { static: true }) matDrawer: MatDrawer
  drawerMode: 'side' | 'over'
  drawerOpened: boolean
  menuData: FuseNavigationItem[] = []
  private _unsubscribeAll: Subject<any> = new Subject<any>()
  private _item: CostCategory
  readonly vm$ = this.store.vm$

  constructor(
    private readonly store: WebCostCategoryDetailStore,
