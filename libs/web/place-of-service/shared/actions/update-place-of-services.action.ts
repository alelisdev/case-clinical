...
import {UserUpdatePlaceOfServiceInput, UpdateResult} from '@case-clinical/shared/util/sdk';

export class UpdatePlaceOfServicesAction extends PlaceOfServiceBusinessActionBase<UpdateResult> {
