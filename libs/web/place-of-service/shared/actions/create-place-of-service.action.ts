...
export class CreatePlaceOfServiceAction extends PlaceOfServiceBusinessActionBase<PlaceOfService> {
  constructor(private input: UserCreatePlaceOfServiceInput) {
