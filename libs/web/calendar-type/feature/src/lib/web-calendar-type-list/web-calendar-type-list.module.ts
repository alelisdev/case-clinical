...
import { WebCalendarTypeListComponent } from './web-calendar-type-list.component'
...
@NgModule({
  declarations: [WebCalendarTypeListComponent],
  imports: [
    ...
    RouterModule.forChild([{ path: '', component: WebCalendarTypeListComponent }]),

  ],
})
export class WebCalendarTypeListModule {}
