...
import { currencyFormatter, dateFormatter, Experience } from '@case-clinical/web/core/data-access'
import { TableViewComponent } from '@case-clinical/web/datatable/ui'

@Component({
  selector: 'ui-experience-select-table-view',
  template: `
    <table-view
...
export class WebExperienceSelectTableViewComponent {
