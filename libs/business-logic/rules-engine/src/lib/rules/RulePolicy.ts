...
export class RulePolicy implements IRuleComponent {
  ...
  /** Use to provide additional information other than validation message */
  attachment: any;
   ...
   */
  constructor(name: string, message: string, isDisplayable = false, severity: Severity = Severity.Exception, priority = 1) {
    this.name = name;
