...
export module Type {
   ...
   * @returns {boolean}
   */
  export function isPrimitive(value: any, allowUndefined = false): value is Primitive {
   ...
   * @returns {boolean}
   */
  export function hasMember(instance: any, property: string, ignoreUndefined = true): boolean {
