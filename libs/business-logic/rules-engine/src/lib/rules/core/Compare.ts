 ...
 * @returns {boolean|any}
 */
export function areEqual(a: any, b: any, strict = true): boolean {
  return a === b
    || !strict && a == b
...
export function compare(a: any, b: any, strict = true): CompareResult {
...
export function areEquivalent(
  a: any, b: any, nullEquivalency = true,
  extraDepth = 0): boolean {
