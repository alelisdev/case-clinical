...
import { PatientInitialDataResolver } from '@case-clinical/web/core/data-access'
...
export const appRoutes: Route[] = [
  ...
  // Auth routes
  {
      ...
      component  : LayoutComponent,
      children: [
        { path: '', loadChildren: () => import('@case-clinical/patient/pages').then(m => m.PatientPagesModule), }
      ],
      data: {
        layout: 'empty'
      },
      resolve    : {
          initialData: PatientInitialDataResolver,
      },
  },
];
...
export class WebPatientShellFeatureModule {}
