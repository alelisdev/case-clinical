...
new ApiCheck('cli-role-feature-permission-check', {name: 'RoleFeaturePermission API',
  activated: true,
...
query UserRoleFeaturePermissions {
  items: userRoleFeaturePermissions(input: {}) {
    name
  }
  count: userCountRoleFeaturePermissions(input: {}) {
    total
  }
}
    `,
