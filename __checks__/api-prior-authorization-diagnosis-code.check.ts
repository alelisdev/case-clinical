...
new ApiCheck('cli-prior-authorization-diagnosis-code-check', {name: 'PriorAuthorizationDiagnosisCode API',
  activated: true,
...
query UserPriorAuthorizationDiagnosisCodes {
  items: userPriorAuthorizationDiagnosisCodes(input: {}) {
    name
  }
  count: userCountPriorAuthorizationDiagnosisCodes(input: {}) {
    total
  }
}
    `,
