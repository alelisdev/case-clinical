...
new ApiCheck('cli-prior-authorization-equipment-check', {name: 'PriorAuthorizationEquipment API',
  activated: true,
...
query UserPriorAuthorizationEquipments {
  items: userPriorAuthorizationEquipments(input: {}) {
    name
  }
  count: userCountPriorAuthorizationEquipments(input: {}) {
    total
  }
}
    `,
