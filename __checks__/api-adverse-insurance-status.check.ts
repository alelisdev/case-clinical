...
new ApiCheck('cli-adverse-insurance-status-check', {name: 'AdverseInsuranceStatus API',
  activated: true,
...
query UserAdverseInsuranceStatuses {
  items: userAdverseInsuranceStatuses(input: {}) {
    name
  }
  count: userCountAdverseInsuranceStatuses(input: {}) {
    total
  }
}
    `,
