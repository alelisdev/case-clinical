...
new ApiCheck('cli-reconciliation-period-type-check', {name: 'ReconciliationPeriodType API',
  activated: true,
...
query UserReconciliationPeriodTypes {
  items: userReconciliationPeriodTypes(input: {}) {
    name
  }
  count: userCountReconciliationPeriodTypes(input: {}) {
    total
  }
}
    `,
