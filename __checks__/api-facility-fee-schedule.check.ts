...
new ApiCheck('cli-facility-fee-schedule-check', {name: 'FacilityFeeSchedule API',
  activated: true,
...
query UserFacilityFeeSchedules {
  items: userFacilityFeeSchedules(input: {}) {
    name
  }
  count: userCountFacilityFeeSchedules(input: {}) {
    total
  }
}
    `,
