...
new ApiCheck('cli-durable-medical-equipment-check', {name: 'DurableMedicalEquipment API',
  activated: true,
...
query UserDurableMedicalEquipments {
  items: userDurableMedicalEquipments(input: {}) {
    name
  }
  count: userCountDurableMedicalEquipments(input: {}) {
    total
  }
}
    `,
