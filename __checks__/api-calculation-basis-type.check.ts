...
new ApiCheck('cli-calculation-basis-type-check', {name: 'CalculationBasisType API',
  activated: true,
...
query UserCalculationBasisTypes {
  items: userCalculationBasisTypes(input: {}) {
    name
  }
  count: userCountCalculationBasisTypes(input: {}) {
    total
  }
}
    `,
