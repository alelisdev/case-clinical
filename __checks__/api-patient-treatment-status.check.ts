...
new ApiCheck('cli-patient-treatment-status-check', {name: 'PatientTreatmentStatus API',
  activated: true,
...
query UserPatientTreatmentStatuses {
  items: userPatientTreatmentStatuses(input: {}) {
    name
  }
  count: userCountPatientTreatmentStatuses(input: {}) {
    total
  }
}
    `,
