...
new ApiCheck('cli-prior-authorization-request-check', {name: 'PriorAuthorizationRequest API',
  activated: true,
...
query UserPriorAuthorizationRequests {
  items: userPriorAuthorizationRequests(input: {}) {
    name
  }
  count: userCountPriorAuthorizationRequests(input: {}) {
    total
  }
}
    `,
