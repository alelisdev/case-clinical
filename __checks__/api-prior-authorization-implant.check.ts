...
new ApiCheck('cli-prior-authorization-implant-check', {name: 'PriorAuthorizationImplant API',
  activated: true,
...
query UserPriorAuthorizationImplants {
  items: userPriorAuthorizationImplants(input: {}) {
    name
  }
  count: userCountPriorAuthorizationImplants(input: {}) {
    total
  }
}
    `,
