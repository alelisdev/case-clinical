...
new ApiCheck('cli-provider-location-check', {name: 'ProviderLocation API',
  activated: true,
  ...
  bodyType: 'GRAPHQL',
  body: `
query UserProviderLocations {
  items: userProviderLocations(input: {}) {
    name
  }
  count: userCountProviderLocations(input: {}) {
    total
  }
}
    `,
